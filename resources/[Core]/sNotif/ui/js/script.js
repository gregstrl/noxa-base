function Notification(title, subtitle, icon, body, duration,location) {
    ...
    text.innerHTML = format(body, "notif");
    ...
    notif.style.animation = "show 0.3s ease-in-out forwards";
    ...
    notif.dataset.to1 = setTimeout(function() {
        notif.style.animation = "hide 0.3s ease-in-out forwards";
...
function HelpNotification(title, icon, body, duration,location) {
    ...
    if (isDefined(icon) || isDefined(title)) {
        ...
        if (isDefined(title)) {
            var p_title = document.createElement("p");
            p_title.innerHTML = format(title, "helpnotif");
    ...
    var text = document.createElement("p");
    text.innerHTML = format(body, "helpnotif");
    ...
    helpnotif.style.animation = "show 0.3s ease-in-out forwards";

    helpnotif.dataset.to1 = setTimeout(function () {
        helpnotif.style.animation = "hide 0.3s ease-in-out forwards";
