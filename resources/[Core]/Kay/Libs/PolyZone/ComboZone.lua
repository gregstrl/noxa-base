...
-- Export de la fonction PolyZone:Create
exports('CreatePolyZone2', function(getPointCb, onPointInOutCb, waitInMS)
  ComboZone:onPointInOut(getPointCb, onPointInOutCb, waitInMS)
end)