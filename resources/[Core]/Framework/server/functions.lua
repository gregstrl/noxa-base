...
---Server side function (exports from Koy resource)
---@param model string
...
function ESX.SpawnVehicle(model, position, heading, plate, locked, xPlayer, callback)
	exports["Koy"]:SpawnVehicle(model, position, heading, plate, locked, xPlayer, callback);
end
...
function ESX.RemoveVehicle(vehiclePlate, callback)
	exports["Koy"]:RemoveVehicle(vehiclePlate, callback);
end
...
function ESX.GiveCarKey(xPlayer, numberPlate, notify)
	exports["Koy"]:GiveCarKey(xPlayer, numberPlate, notify);
end
...
function ESX.DoesSocietyExist(societyName)
	return exports["Koy"]:SocietyExist(societyName);
end
...
function ESX.GetSocietyMoney(societyName)
	return exports["Koy"]:GetSocietyMoney(societyName);
end
...
function ESX.AddSocietyMoney(societyName, amount)
	exports["Koy"]:AddSocietyMoney(societyName, amount);
end
...
function ESX.RemoveSocietyMoney(societyName, amount)
	exports["Koy"]:RemoveSocietyMoney(societyName, amount);
end
...
function ESX.AddSociety(name, label, canWashMoney, canUseOffshore, societyType, callback)
	exports["Koy"]:AddSociety(name, label, canWashMoney, canUseOffshore, societyType, callback);
end
