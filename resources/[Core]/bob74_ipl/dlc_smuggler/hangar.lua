...
SmugglerHangar = {
    ...
    Bedroom = {
        Style = {
            ...
            Clear = function(refresh)
                SetIplPropState(SmugglerHangar.interiorId, {
                    SmugglerHangar.Bedroom.Style.Mercury,
    ...
    LoadDefault = function()
        ...
        SmugglerHangar.Bedroom.Style.Set(SmugglerHangar.Bedroom.Style.Mercury, SmugglerHangar.Colors.colorSet1)
