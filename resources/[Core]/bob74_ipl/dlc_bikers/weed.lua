...
BikerWeedFarm = {
    ...
    LoadDefault = function()
        ...
        --BikerWeedFarm.Plant1.Stage.Set(BikerWeedFarm.Plant1.Stage.small)
        --BikerWeedFarm.Plant2.Stage.Set(BikerWeedFarm.Plant2.Stage.small)
        --BikerWeedFarm.Plant3.Stage.Set(BikerWeedFarm.Plant3.Stage.small)
        --BikerWeedFarm.Plant4.Stage.Set(BikerWeedFarm.Plant4.Stage.small)
        --BikerWeedFarm.Plant5.Stage.Set(BikerWeedFarm.Plant5.Stage.small)
        --BikerWeedFarm.Plant6.Stage.Set(BikerWeedFarm.Plant6.Stage.small)
        --BikerWeedFarm.Plant7.Stage.Set(BikerWeedFarm.Plant7.Stage.small)
        --BikerWeedFarm.Plant8.Stage.Set(BikerWeedFarm.Plant8.Stage.small)
        --BikerWeedFarm.Plant9.Stage.Set(BikerWeedFarm.Plant9.Stage.small)

        BikerWeedFarm.Plant1.Hose.Enable(false, false)
        BikerWeedFarm.Plant2.Hose.Enable(false, false)
        BikerWeedFarm.Plant3.Hose.Enable(false, false)
        BikerWeedFarm.Plant4.Hose.Enable(false, false)
        BikerWeedFarm.Plant5.Hose.Enable(false, false)
        BikerWeedFarm.Plant6.Hose.Enable(false, false)
        BikerWeedFarm.Plant7.Hose.Enable(false, false)
        BikerWeedFarm.Plant8.Hose.Enable(false, false)
        BikerWeedFarm.Plant9.Hose.Enable(false, false)

        BikerWeedFarm.Plant1.Light.Set(BikerWeedFarm.Plant1.Light.basic, false)
        BikerWeedFarm.Plant2.Light.Set(BikerWeedFarm.Plant2.Light.basic, false)
        BikerWeedFarm.Plant3.Light.Set(BikerWeedFarm.Plant3.Light.basic, false)
        BikerWeedFarm.Plant4.Light.Set(BikerWeedFarm.Plant4.Light.basic, false)
        BikerWeedFarm.Plant5.Light.Set(BikerWeedFarm.Plant5.Light.basic, false)
        BikerWeedFarm.Plant6.Light.Set(BikerWeedFarm.Plant6.Light.basic, false)
        BikerWeedFarm.Plant7.Light.Set(BikerWeedFarm.Plant7.Light.basic, false)
        BikerWeedFarm.Plant8.Light.Set(BikerWeedFarm.Plant8.Light.basic, false)
        BikerWeedFarm.Plant9.Light.Set(BikerWeedFarm.Plant9.Light.basic, false)
