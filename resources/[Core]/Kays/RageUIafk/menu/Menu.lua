...
---@param B number
---@param A number
---@return RageUIafkMenus
---@public
function RageUIafk.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = RageUIafk.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = RageUIafk.UI.Style[RageUIafk.UI.Current].Width
    Menu.Open = false
    Menu.Controls = RageUIafk.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + RageUIafk.Settings.Items.Subtitle.Text.X, Menu.Y + RageUIafk.Settings.Items.Subtitle.Text.Y, 0, RageUIafk.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIafk.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, RageUIafk.Menus)
end
...
---@return RageUIafkMenus
---@public
function RageUIafk.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    if ParentMenu ~= nil then
        if ParentMenu() then
            local Menu = RageUIafk.CreateMenu(Title or ParentMenu.Title, Subtitle or ParentMenu.Subtitle, X or ParentMenu.X, Y or ParentMenu.Y)
...
---@return nil
---@public
function RageUIafk.Menus:SetTitle(Title)
    self.Title = Title
end

function RageUIafk.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function RageUIafk.Menus:GetStyleSize()
...
---@return void
---@public
function RageUIafk.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function RageUIafk.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function RageUIafk.Menus:UpdateCursorStyle()
...
---@return void
---@public
function RageUIafk.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function RageUIafk.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + RageUIafk.Settings.Items.Subtitle.Text.X, self.Y + RageUIafk.Settings.Items.Subtitle.Text.Y, 0, RageUIafk.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIafk.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function RageUIafk.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function RageUIafk.Menus:EditSpriteColor(R, G, B, A)
...
---@return nil
---@public
function RageUIafk.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function RageUIafk.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function RageUIafk.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function RageUIafk.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function RageUIafk.Menus:Closable(boolean)
...
function RageUIafk.Menus:AddInstructionButton(button)
...
function RageUIafk.Menus:RemoveInstructionButton(button)
...
function RageUIafk.Menus:UpdateInstructionalButtons(Visible)
