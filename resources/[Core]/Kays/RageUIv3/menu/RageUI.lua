    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            if (CurrentMenu.Display.Glare) then
                ...
                ---@type number
                local Glarewidth = RageUIv3.Settings.Items.Title.Background.Width
                ---@type number
                local Glareheight = RageUIv3.Settings.Items.Title.Background.Height + 1.5
                ---@type number
                ...
                RageUIv3.SetScaleformParams(ScaleformMovie, {
            ...
            RenderText(CurrentMenu.Title, CurrentMenu.X + RageUIv3.Settings.Items.Title.Text.X + (CurrentMenu.WidthOffset / 2), CurrentMenu.Y + RageUIv3.Settings.Items.Title.Text.Y, CurrentMenu.TitleFont, CurrentMenu.TitleScale, 255, 255, 255, 255, 1)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Subtitle) then
            ...
            if CurrentMenu.Subtitle ~= "" then
                RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUIv3.ItemOffset, RageUIv3.Settings.Items.Subtitle.Background.Width + CurrentMenu.WidthOffset, RageUIv3.Settings.Items.Subtitle.Background.Height + CurrentMenu.SubtitleHeight, 18, 22, 24, 150)
                RenderText((CurrentMenu.PageCounterColour .. CurrentMenu.Subtitle), CurrentMenu.X + RageUIv3.Settings.Items.Subtitle.Text.X, CurrentMenu.Y + RageUIv3.Settings.Items.Subtitle.Text.Y + RageUIv3.ItemOffset, 8, RageUIv3.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIv3.Settings.Items.Subtitle.Background.Width + CurrentMenu.WidthOffset)
                ...
                if CurrentMenu.Display.PageCounter then
                    if CurrentMenu.PageCounter == nil then
                        RenderText(CurrentMenu.PageCounterColour .. CurrentMenu.Index .. " / " .. CurrentMenu.Options, CurrentMenu.X + RageUIv3.Settings.Items.Subtitle.PreText.X + CurrentMenu.WidthOffset, CurrentMenu.Y + RageUIv3.Settings.Items.Subtitle.PreText.Y + RageUIv3.ItemOffset, 8, RageUIv3.Settings.Items.Subtitle.PreText.Scale, 245, 245, 245, 255, 2)
                    else
                        RenderText(CurrentMenu.PageCounter, CurrentMenu.X + RageUIv3.Settings.Items.Subtitle.PreText.X + CurrentMenu.WidthOffset, CurrentMenu.Y + RageUIv3.Settings.Items.Subtitle.PreText.Y + RageUIv3.ItemOffset, 8, RageUIv3.Settings.Items.Subtitle.PreText.Scale, 245, 245, 245, 255, 2)
                    end
                end
...
function RageUIv3.Background()
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Background) then
            ...
            -- RenderSprite(RageUIv3.Settings.Items.Background.Dictionary, RageUIv3.Settings.Items.Background.Texture, CurrentMenu.X, CurrentMenu.Y + RageUIv3.Settings.Items.Background.Y + CurrentMenu.SubtitleHeight, RageUIv3.Settings.Items.Background.Width + CurrentMenu.WidthOffset, RageUIv3.ItemOffset, 0, 18, 22, 24, 255)

            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUIv3.Settings.Items.Background.Y + CurrentMenu.SubtitleHeight, RageUIv3.Settings.Items.Background.Width + CurrentMenu.WidthOffset, RageUIv3.ItemOffset + 7, 1, 1, 1, 140)
...
function RageUIv3.Description()
    ...
    if CurrentMenu ~= nil and CurrentMenu.Description ~= nil then
        if CurrentMenu() then
            RageUIv3.ItemsSafeZone(CurrentMenu)
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + Description.Background.Y + CurrentMenu.SubtitleHeight + RageUIv3.ItemOffset + 5, Description.Background.Width + CurrentMenu.WidthOffset, CurrentMenu.DescriptionHeight, 1, 1, 1, 140)

            RenderText(CurrentMenu.Description, CurrentMenu.X + Description.Text.X, CurrentMenu.Y + Description.Text.Y + CurrentMenu.SubtitleHeight + RageUIv3.ItemOffset + 5, 0, Description.Text.Scale, 255, 255, 255, 255, nil, false, false, Description.Background.Width + CurrentMenu.WidthOffset - 8.0)
...
function RageUIv3.ItemsDescription(CurrentMenu, Description, Selected)
    ...
    if Description ~= "" or Description ~= nil then
        ...
        if Selected and CurrentMenu.Description ~= Description then
            ...
            ---@type number
            local DescriptionLineCount = GetLineCount(CurrentMenu.Description, CurrentMenu.X + SettingsDescription.Text.X, CurrentMenu.Y + SettingsDescription.Text.Y + CurrentMenu.SubtitleHeight + RageUIv3.ItemOffset, 0, SettingsDescription.Text.Scale, 18, 22, 24, 1, nil, false, false, SettingsDescription.Background.Width + (CurrentMenu.WidthOffset - 5.0))
