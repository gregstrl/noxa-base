...
function RageUI.SliderPanel(Value, MinValue, UpperText, MaxValue, Actions, Index)
	...
	if CurrentMenu ~= nil then
		if CurrentMenu() and ((CurrentMenu.Index == Index)) then
            ...
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + Slider.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset + 3, Slider.Background.Width + CurrentMenu.WidthOffset, Slider.Background.Height, 1, 1, 1, 140)
