    ...
    if CurrentMenu ~= nil then
        ...
        if CurrentMenu() then
            if (Options ~= 0) then
                ...
                RageUIv2.ReloadAnimation()
                RageUIv2.ReloadAnimationCheckBox()
                RageUIv2.ReloadAnimationList()
...
function RageUIv2.GoActionControl(Controls, Action)
...
function RageUIv2.GoActionControlSlider(Controls, Action)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            if CurrentMenu.Open then
                ...
                RageUIv2.Options = CurrentMenu.Options
                ...
                for i = 1, #ControlActions do
                    RageUIv2.GoActionControl(Controls, ControlActions[i])
                end

                RageUIv2.GoActionControlSlider(Controls, 'SliderLeft')
                RageUIv2.GoActionControlSlider(Controls, 'SliderRight')
...
function RageUIv2.Navigation()
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Navigation) then
            ...
            if RageUIv2.Options > CurrentMenu.Pagination.Total then
                ...
                if CurrentMenu.EnableMouse then
                    UpHovered = RageUIv2.IsMouseInBounds(CurrentMenu.X + CurrentMenu.SafeZoneSize.X, CurrentMenu.Y + CurrentMenu.SafeZoneSize.Y + CurrentMenu.SubtitleHeight + RageUIv2.ItemOffset, RageUIv2.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUIv2.Settings.Items.Navigation.Rectangle.Height)
                    DownHovered = RageUIv2.IsMouseInBounds(CurrentMenu.X + CurrentMenu.SafeZoneSize.X, CurrentMenu.Y + RageUIv2.Settings.Items.Navigation.Rectangle.Height + CurrentMenu.SafeZoneSize.Y + CurrentMenu.SubtitleHeight + RageUIv2.ItemOffset, RageUIv2.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUIv2.Settings.Items.Navigation.Rectangle.Height)
                    ...
                    if UpHovered then
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y + CurrentMenu.SubtitleHeight + RageUIv2.ItemOffset, RageUIv2.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUIv2.Settings.Items.Navigation.Rectangle.Height, 30, 30, 30, 255)
                    else
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y + CurrentMenu.SubtitleHeight + RageUIv2.ItemOffset, RageUIv2.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUIv2.Settings.Items.Navigation.Rectangle.Height, 0, 0, 0, 200)
                    end

                    if DownHovered then
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUIv2.Settings.Items.Navigation.Rectangle.Height + CurrentMenu.SubtitleHeight + RageUIv2.ItemOffset, RageUIv2.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUIv2.Settings.Items.Navigation.Rectangle.Height, 30, 30, 30, 255)
                    else
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUIv2.Settings.Items.Navigation.Rectangle.Height + CurrentMenu.SubtitleHeight + RageUIv2.ItemOffset, RageUIv2.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUIv2.Settings.Items.Navigation.Rectangle.Height, 0, 0, 0, 200)
                    end
                else
                    RenderRectangle(CurrentMenu.X, CurrentMenu.Y + CurrentMenu.SubtitleHeight + RageUIv2.ItemOffset, RageUIv2.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUIv2.Settings.Items.Navigation.Rectangle.Height, 0, 0, 0, 200)
                    RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUIv2.Settings.Items.Navigation.Rectangle.Height + CurrentMenu.SubtitleHeight + RageUIv2.ItemOffset, RageUIv2.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUIv2.Settings.Items.Navigation.Rectangle.Height, 0, 0, 0, 200)
                end
                RenderSprite(RageUIv2.Settings.Items.Navigation.Arrows.Dictionary, RageUIv2.Settings.Items.Navigation.Arrows.Texture, CurrentMenu.X + RageUIv2.Settings.Items.Navigation.Arrows.X + (CurrentMenu.WidthOffset / 2), CurrentMenu.Y + RageUIv2.Settings.Items.Navigation.Arrows.Y + CurrentMenu.SubtitleHeight + RageUIv2.ItemOffset, RageUIv2.Settings.Items.Navigation.Arrows.Width, RageUIv2.Settings.Items.Navigation.Arrows.Height)
