...
---@param B number
---@param A number
---@return RageUIv2Menus
---@public
function RageUIv2.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = RageUIv2.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = RageUIv2.UI.Style[RageUIv2.UI.Current].Width
    Menu.Open = false
    Menu.Controls = RageUIv2.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + RageUIv2.Settings.Items.Subtitle.Text.X, Menu.Y + RageUIv2.Settings.Items.Subtitle.Text.Y, 0, RageUIv2.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIv2.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, RageUIv2.Menus)
end
...
---@return RageUIv2Menus
---@public
function RageUIv2.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    if ParentMenu ~= nil then
        if ParentMenu() then
            local Menu = RageUIv2.CreateMenu(Title or ParentMenu.Title, Subtitle or ParentMenu.Subtitle, X or ParentMenu.X, Y or ParentMenu.Y)
...
---@return nil
---@public
function RageUIv2.Menus:SetTitle(Title)
    self.Title = Title
end

function RageUIv2.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function RageUIv2.Menus:GetStyleSize()
...
---@return void
---@public
function RageUIv2.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function RageUIv2.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function RageUIv2.Menus:UpdateCursorStyle()
...
---@return void
---@public
function RageUIv2.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function RageUIv2.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + RageUIv2.Settings.Items.Subtitle.Text.X, self.Y + RageUIv2.Settings.Items.Subtitle.Text.Y, 0, RageUIv2.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIv2.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function RageUIv2.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function RageUIv2.Menus:EditSpriteColor(R, G, B, A)
...
---@return nil
---@public
function RageUIv2.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function RageUIv2.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function RageUIv2.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function RageUIv2.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function RageUIv2.Menus:Closable(boolean)
...
function RageUIv2.Menus:AddInstructionButton(button)
...
function RageUIv2.Menus:RemoveInstructionButton(button)
...
function RageUIv2.Menus:UpdateInstructionalButtons(Visible)
