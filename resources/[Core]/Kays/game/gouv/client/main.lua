        ...
        if ESX.PlayerData.job.name == 'gouv' then
            if #(plyCoords - Config.Gouv.Armurerie) <= 10 then
                if ESX.PlayerData.job.grade ~= 0 and ESX.PlayerData.job.grade ~= 1 then
                    interval = 1
                    DrawMarker(Config.Marker.Type, Config.Gouv.Armurerie, 0, 0, 0, Config.Marker.Rotation, nil, nil, Config.Marker.Size[1], Config.Marker.Size[2], Config.Marker.Size[3], 247,247,247, 170, 0, 1, 0, 0, nil, nil, 0)
            ...
            if #(plyCoords - Config.Gouv.Vestiaire) <= 10 then
                if ESX.PlayerData.job.grade ~= 0 and ESX.PlayerData.job.grade ~= 1 then
                    interval = 1
                    DrawMarker(Config.Marker.Type, Config.Gouv.Vestiaire, 0, 0, 0, Config.Marker.Rotation, nil, nil, Config.Marker.Size[1], Config.Marker.Size[2], Config.Marker.Size[3], 247,247,247, 170, 0, 1, 0, 0, nil, nil, 0)
            ...
            if #(plyCoords - Config.Gouv.SortirVehicule) <= 10 then
                interval = 1
                DrawMarker(Config.Marker.Type, Config.Gouv.SortirVehicule, 0, 0, 0, Config.Marker.Rotation, nil, nil, Config.Marker.Size[1], Config.Marker.Size[2], Config.Marker.Size[3], 247,247,247, 170, 0, 1, 0, 0, nil, nil, 0)
            ...
            if #(plyCoords - Config.Gouv.RangerVehicle) <= 10 then
                ...
                if DoesEntityExist(veh) then
                    interval = 1
                    DrawMarker(Config.Marker.Type, Config.Gouv.RangerVehicle, 0, 0, 0, Config.Marker.Rotation, nil, nil, Config.Marker.Size[1], Config.Marker.Size[2], Config.Marker.Size[3], 247,247,247, 170, 0, 1, 0, 0, nil, nil, 0)
...
function openGouvCloathroom()
    local mainMenu = RageUI.CreateMenu('', 'Gouvernement San Andreas')
