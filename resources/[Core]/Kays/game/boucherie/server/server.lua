...
local items = {
    ["viande_1"] = {price = 190, sell = true},
    ["viande_2"] = {price = 310, sell = true},
}
...
RegisterNetEvent("Boucherie:sellItem", function(item, selectCount)
    ...
    if selectCount > itemCount then return TriggerClientEvent("esx:showNotification", source, "[~r~Impossible~h~] n'avez pas cela sur vous !") end
