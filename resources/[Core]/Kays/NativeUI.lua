...
Colours = {
    ...
    Purple = {0, 85, 255, 255},
    PurpleLight = {0, 85, 255, 255},
    PurpleDark = {0, 85, 255, 255},
    Pink = {203, 54, 148, 255},
...
function UIMenuItem.New(Text, Description)
    _UIMenuItem = {
        ...
        SelectedSprite = Sprite.New("k2r", "gradient_nav", 0, 0, 431, 38),
        LeftBadge = { Sprite = Sprite.New("k2r", "", 0, 0, 40, 40), Badge = 0},
        RightBadge = { Sprite = Sprite.New("k2r", "", 0, 0, 40, 40), Badge = 0},
        Label = {
...
function UIMenuCheckboxItem.New(Text, Check, Description)
    local _UIMenuCheckboxItem = {
        ...
        CheckedSprite = Sprite.New("k2r", "shop_box_blank", 410, 95, 50, 50),
...
function UIMenuListItem.New(Text, Items, Index, Description)
    ...
    local _UIMenuListItem = {
        Base = UIMenuItem.New(Text or "", Description or ""),
        Items = Items,
        LeftArrow = Sprite.New("k2r", "arrowleft", 110, 105, 30, 30),
        RightArrow = Sprite.New("k2r", "arrowright", 280, 105, 30, 30),
...
function UIMenuListItem:Draw()
    ...
    if self:Enabled() then
        if self:Selected() then
            self.ItemText:Colour(17, 17, 17, 255)
            self.LeftArrow:Colour(17, 17, 17, 255)
            self.RightArrow:Colour(17, 17, 17, 255)
        else
...
function UIMenuSliderItem.New(Text, Items, Index, Description, Divider)
    ...
    local _UIMenuSliderItem = {
        ...
        LeftArrow = Sprite.New("k2rtu", "arrowleft", 0, 105, 15, 15),
        RightArrow = Sprite.New("k2rtu", "arrowright", 0, 105, 15, 15),
...
function UIMenuGridPanel.New(TopText, LeftText, RightText, BottomText)
    _UIMenuGridPanel = {
        ...
        Background = Sprite.New("k2r", "gradient_bgd", 0, 0, 431, 275),
...
function UIMenuColourPanel.New(Title, Colours)
    _UIMenuColourPanel = {
        ...
        Background = Sprite.New("k2r", "gradient_bgd", 0, 0, 431, 112),
        Bar = {},
        LeftArrow = Sprite.New("k2r", "arrowleft", 0, 0, 30, 30),
        RightArrow = Sprite.New("k2r", "arrowright", 0, 0, 30, 30),
...
function UIMenuPercentagePanel.New(MinText, MaxText)
    _UIMenuPercentagePanel = {
        ...
        Background = Sprite.New("k2r", "gradient_bgd", 0, 0, 431, 76),
...
function UIMenu.New(Title, Subtitle, X, Y, TxtDictionary, TxtName)
    ...
    if TxtDictionary ~= nil then TxtDictionary = tostring(TxtDictionary) or "k2r" else TxtDictionary = "k2r" end
    ...
    if Subtitle ~= "" and Subtitle ~= nil then
        _UIMenu.Subtitle.Rectangle = UIResRectangle.New(0 + _UIMenu.Position.X, 107 + _UIMenu.Position.Y, 431, 37, 17, 17, 17, 255)
    ...
    _UIMenu.ArrowSprite = Sprite.New("k2r", "shop_arrows_upanddown", 190 + _UIMenu.Position.X, 147 + 37 * (_UIMenu.Pagination.Total + 1) + _UIMenu.Position.Y - 37 + _UIMenu.Subtitle.ExtraY, 50, 50)
    ...
    _UIMenu.Description.Bar = UIResRectangle.New(_UIMenu.Position.X, 123, 431, 4, 17, 17, 17, 255)
    _UIMenu.Description.Rectangle = Sprite.New("k2r", "gradient_bgd", _UIMenu.Position.X, 127, 431, 30)
    _UIMenu.Description.Text = UIResText.New("Description", _UIMenu.Position.X + 5, 125, 0.35)

    _UIMenu.Background = Sprite.New("k2r", "gradient_bgd", _UIMenu.Position.X, 144 + _UIMenu.Position.Y - 37 + _UIMenu.Subtitle.ExtraY, 290, 25)
