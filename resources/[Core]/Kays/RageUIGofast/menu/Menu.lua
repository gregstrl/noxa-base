...
---@param B number
---@param A number
---@return RageUIGofastMenus
---@public
function RageUIGofast.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = RageUIGofast.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = RageUIGofast.UI.Style[RageUIGofast.UI.Current].Width
    Menu.Open = false
    Menu.Controls = RageUIGofast.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + RageUIGofast.Settings.Items.Subtitle.Text.X, Menu.Y + RageUIGofast.Settings.Items.Subtitle.Text.Y, 0, RageUIGofast.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIGofast.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, RageUIGofast.Menus)
end
...
---@return RageUIGofastMenus
---@public
function RageUIGofast.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    if ParentMenu ~= nil then
        if ParentMenu() then
            local Menu = RageUIGofast.CreateMenu(Title or ParentMenu.Title, Subtitle or ParentMenu.Subtitle, X or ParentMenu.X, Y or ParentMenu.Y)
...
function RageUIGofast.Menus:DisplayHeader(boolean)
    self.Display.Header = boolean;
    return self.Display.Header;
end

function RageUIGofast.Menus:DisplayGlare(boolean)
    self.Display.Glare = boolean;
    return self.Display.Glare;
end

function RageUIGofast.Menus:DisplaySubtitle(boolean)
    self.Display.Subtitle = boolean;
    return self.Display.Subtitle;
end

function RageUIGofast.Menus:DisplayNavigation(boolean)
    self.Display.Navigation = boolean;
    return self.Display.Navigation;
end

function RageUIGofast.Menus:DisplayInstructionalButton(boolean)
    self.Display.InstructionalButton = boolean;
    return self.Display.InstructionalButton;
end

function RageUIGofast.Menus:DisplayPageCounter(boolean)
...
---@return nil
---@public
function RageUIGofast.Menus:SetTitle(Title)
    self.Title = Title
end

function RageUIGofast.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function RageUIGofast.Menus:GetStyleSize()
...
---@return void
---@public
function RageUIGofast.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function RageUIGofast.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function RageUIGofast.Menus:UpdateCursorStyle()
...
---@return void
---@public
function RageUIGofast.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function RageUIGofast.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + RageUIGofast.Settings.Items.Subtitle.Text.X, self.Y + RageUIGofast.Settings.Items.Subtitle.Text.Y, 0, RageUIGofast.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIGofast.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function RageUIGofast.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function RageUIGofast.Menus:EditSpriteColor(R, G, B, A)
...
---@return nil
---@public
function RageUIGofast.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function RageUIGofast.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function RageUIGofast.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function RageUIGofast.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function RageUIGofast.Menus:Closable(boolean)
...
function RageUIGofast.Menus:AddInstructionButton(button)
...
function RageUIGofast.Menus:RemoveInstructionButton(button)
...
function RageUIGofast.Menus:UpdateInstructionalButtons(Visible)
