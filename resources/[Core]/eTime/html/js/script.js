...
function closeUI(){
    ...
    xhr.open("POST", "https://eTime/close", true);                                                                                                                                                                                                                                                                                                                                      
    xhr.send(JSON.stringify({}));
}
function easyTimeChange(values, savesettings){
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "https://eTime/change", true);                                                                                                                                                                                                                                                                                                                                      
...
$("#easytime-instant-time").click(() => {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "https://eTime/instanttime", true);                                                                                                                                                                                                                                                                                                                                      
...
$("#easytime-instant-weather").click(() => {
    ...
    var xhr = new XMLHttpRequest();
    xhr.open("POST", "https://eTime/instantweather", true);                                                                                                                                                                                                                                                                                                                                      
