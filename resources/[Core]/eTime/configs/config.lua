...
Config.Language = 'FR' --[ 'EN' / 'FR' / 'ES' ] You can add your own locales to the Locales.lua. But make sure to add it here.
...
Config.FrameworkTriggers = { --You can change the esx/qbcore events (IF NEEDED).
    ...
    resource_name = 'Framework'   --ESX = 'Framework'           QBCORE = 'qb-core'
}
...
Config.TsunamiWarning_time = 1 --(in minutes) How long the tsunami warning should last. Read the docs for more info.
