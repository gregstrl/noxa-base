robberiesConfiguration = {
    ...
    items = {
        ["TV"] = {name = "Téléviseur", resellerValue = 2500, timeToTake = 10},
        ["CLOTHS"] = {name = "Vêtements", resellerValue = 300, timeToTake = 5},
        ["CLOTHSRICHE"] = {name = "Vêtements de Luxe", resellerValue = 750, timeToTake = 5},
        ["ECOMP"] = {name = "Composants électroniques", resellerValue = 200, timeToTake = 4},
        ["ORANGE"] = {name = "Fruits", resellerValue = 80, timeToTake = 2},
        ["TELEPHONE"] = {name = "iPhone", resellerValue = 300, timeToTake = 4},
        ["PORNO"] = {name = "Magasine Pornographique", resellerValue = 300, timeToTake = 1},
        ["PARFUM"] = {name = "Parfum Channel", resellerValue = 450, timeToTake = 3},
        ["TV4K60FPS"] = {name = "TV 4K 60FPS", resellerValue = 2500, timeToTake = 10},
        ["BOITEBIJOUX"] = {name = "Boite a Bijoux", resellerValue = 800, timeToTake = 10},
        ["PCPORTABLE"] = {name = "Asus Rog 144Hz", resellerValue = 3000, timeToTake = 5},
        ["TABLEAU"] = {name = "Tableau Pablo Picasso", resellerValue = 2000, timeToTake = 15},
        ["ECRANMAC"] = {name = "Ecran Mac", resellerValue = 1200, timeToTake = 8},
        ["JAGUAR"] = {name = "Jaguar", resellerValue = 400, timeToTake = 5},
        ["PERCEUSE"] = {name = "Perceuse", resellerValue = 360, timeToTake = 6},
        ["DEVICE"] = {name = "Device", resellerValue = 500, timeToTake = 5},
        ["BOITEOUTILS"] = {name = "Boite a Outils", resellerValue = 300, timeToTake = 5},
        ["COMPRESSEUR"] = {name = "Compresseur", resellerValue = 400, timeToTake = 8},
        ["PEINTURE"] = {name = "Peinture", resellerValue = 200, timeToTake = 5},
        ["CHEVRE"] = {name = "Chevre Mécanique", resellerValue = 300, timeToTake = 5},
        ["ASPIRATEUR"] = {name = "Aspirateur Mécanique", resellerValue = 300, timeToTake = 6},
        ["BANSHEE"] = {name = "Tableau Banshee", resellerValue = 200, timeToTake = 5},
        ["OUTILS"] = {name = "Outils", resellerValue = 300, timeToTake = 5},
        ["FEUILLECASH"] = {name = "Feuille Cash", resellerValue = 300, timeToTake = 2},
        ["DOCUMENTS"] = {name = "Documents Labo", resellerValue = 200, timeToTake = 2},
        ["BILLET"] = {name = "Billet Cash Factory", resellerValue = 2000, timeToTake = 2},
        ["BILLET1"] = {name = "Pile de Cash", resellerValue = 300, timeToTake = 5},
        ["BILLET2"] = {name = "Billet de Cash Factory", resellerValue = 200, timeToTake = 5},
        ["PRODUITCOC"] = {name = "Produit Cocaine", resellerValue = 200, timeToTake = 6},
        ["COCAINA"] = {name = "Cocaine", resellerValue = 150, timeToTake = 4},
        ["CANNA"] = {name = "Cannabis", resellerValue = 300, timeToTake = 2},
        ["CANNATRAIT"] = {name = "Cannabis traite", resellerValue = 150, timeToTake = 5},
        ["DISQUEDUR"] = {name = "Disque Dur", resellerValue = 160, timeToTake = 5},
        ["TABLEAUPAUVRE"] = {name = "Tableau Décoration", resellerValue = 220, timeToTake = 8},
        ["BROSSEADENTS"] = {name = "Brosse a dents", resellerValue = 40, timeToTake = 2},
        ["SECHECHEVEUX"] = {name = "Seche Cheveux", resellerValue = 70, timeToTake = 3},
        ["LIVRES"] = {name = "Livres", resellerValue = 60, timeToTake = 8},
        ["JACK"] = {name = "Bouteille de Jack", resellerValue = 120, timeToTake = 2},
    },
