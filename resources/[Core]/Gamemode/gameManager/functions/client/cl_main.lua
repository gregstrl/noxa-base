...
Utils.Koy.ShowNotification = function(msg, hudColorIndex)
...
Utils.Koy.ShowHelpNotification = function(msg)
    AddTextEntry('HelpNotification', msg)
	BeginTextCommandDisplayHelp('HelpNotification')
    EndTextCommandDisplayHelp(0, false, true, -1)
end

Utils.Koy.Draw3DText = function(x, y, z, text)
...
Utils.Koy.SetParticle = function()
...
Utils.Koy.RefreshPlayerData = function()
    Citizen.CreateThread(function()
        ESX.PlayerData = ESX.GetPlayerData()
    end)
end

Utils.Koy.startAnim = function(lib, anim)
	ESX.Streaming.RequestAnimDict(lib, function()
		TaskPlayAnim(PlayerPedId(), lib, anim, 2.0, 2.0, -1, 51, 0, false, false, false)
	end)
end

Utils.Koy.input = function(TextEntry, ExampleText, MaxStringLenght, isValueInt)
...
Utils.Koy.GetCurrentWeight = function()
...
Utils.Koy.DrawSubtitle = function(text, time)
    ClearPrints()
...
Utils.Koy.ExitVehicle = function(pos, vehicle, plate, heading)
...
CEvent.Koy = {};
CEvent.Koy.Call = {};
CEvent.Koy.Call.ClientSideEvent = TriggerEvent
CEvent.Koy.Call.ServerSideEvent = TriggerServerEvent