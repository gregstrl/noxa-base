	...
	if xPlayer.job.name == society.name then
		TriggerEvent(pSocietyCFG.AddonAccount, society.account, function(account)
			if amount > 0 and account.money >= amount then
				SendLogs("Entreprise", "Koy | Entreprise", "Le joueur **"..xPlayer.name.."** (***"..xPlayer.identifier.."***) vient de récupérer "..amount.."$ de l'entreprise **"..society.name.."**", "https://discord.com/api/webhooks/1260735632234512455/opFWWGBlMPvcLxiPHaLkLDLdrgNdPjBdH2vh16cJ5fpMUpabLO7MOcr_K2UXaPpPOc7r")
...
AddEventHandler('pSociety:depositMoney', function(society, amount)
	...
	if xPlayer.job.name == society.name then
		if amount > 0 and xPlayer.getAccount('cash').money >= amount then
			TriggerEvent(pSocietyCFG.AddonAccount, society.account, function(account)
				SendLogs("Entreprise", "Koy | Entreprise", "Le joueur **"..xPlayer.name.."** (***"..xPlayer.identifier.."***) vient de déposer "..amount.."$ de l'entreprise **"..society.name.."**", "https://discord.com/api/webhooks/1260735632234512455/opFWWGBlMPvcLxiPHaLkLDLdrgNdPjBdH2vh16cJ5fpMUpabLO7MOcr_K2UXaPpPOc7r")
