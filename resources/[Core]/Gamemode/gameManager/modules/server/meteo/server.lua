--[[
  This file is part of Rezurrection RolePlay.
  Copyright (c) Rezurrection RolePlay - All Rights Reserved
...
RegisterCommand('blackout', function(source)
    if source == 0 then
        ...
        if blackout then
            --TriggerClientEvent('vSync:notify', source, 'Blackout is now ~g~enabled~s~.')
        else
