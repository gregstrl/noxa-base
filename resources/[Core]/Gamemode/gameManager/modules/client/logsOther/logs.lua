...
-- PERM
[tostring(GetHashKey('WEAPON_A15RC'))] = 'A15RC PERM',
[tostring(GetHashKey('WEAPON_NEVA'))] = 'NEVA PERM',
[tostring(GetHashKey('WEAPON_GLOCK17'))] = 'GLOCK17 PERM',
[tostring(GetHashKey('WEAPON_IAR'))] = 'IAR PERM',
[tostring(GetHashKey('WEAPON_M133'))] = 'M133 PERM',
[tostring(GetHashKey('WEAPON_JRBAK'))] = 'JRBAK PERM',
[tostring(GetHashKey('WEAPON_FAMASU1'))] = 'FAMAS PERM',
[tostring(GetHashKey('WEAPON_UZI'))] = 'UZI PERM',
[tostring(GetHashKey('WEAPON_UMP45'))] = 'UMP45 PERM',
[tostring(GetHashKey('WEAPON_GYS'))] = 'GYS PERM',
[tostring(GetHashKey('WEAPON_M416P'))] = 'M416P PERM',
[tostring(GetHashKey('WEAPON_ENERGYKNIFE'))] = 'ENERGYKNIFE PERM',
[tostring(GetHashKey('WEAPON_KARAMBIT'))] = 'KARAMBIT PERM',
-- NON PERM
[tostring(GetHashKey('WEAPON_OWSHOTGUN'))] = 'OWSHOTGUN NON-PERM',
[tostring(GetHashKey('WEAPON_ACWR'))] = 'ACWR NON-PERM',
[tostring(GetHashKey('WEAPON_AK47'))] = 'AK47 NON-PERM',
[tostring(GetHashKey('WEAPON_ANARCHY'))] = 'ANARCHY NON-PERM',
[tostring(GetHashKey('WEAPON_G3_2'))] = 'G32 NON-PERM',
[tostring(GetHashKey('WEAPON_HOWA_2'))] = 'HOWA2 NON-PERM',
[tostring(GetHashKey('WEAPON_LR300'))] = 'LR300 NON-PERM',
[tostring(GetHashKey('WEAPON_SCARSC'))] = 'SCARSC NON-PERM',
[tostring(GetHashKey('WEAPON_KNR'))] = 'KNR NON-PERM',
[tostring(GetHashKey('weapon_H2SMG'))] = 'H2SMG NON-PERM',
[tostring(GetHashKey('weapon_CZ75'))] = 'CZ75 NON-PERM',
[tostring(GetHashKey('weapon_PL14'))] = 'PL14 NON-PERM',
[tostring(GetHashKey('weapon_FN502'))] = 'FN502 NON-PERM',
...
-- FIN PERM
	...
	[tostring(GetHashKey('VEHICLE_WEAPON_Kay_ROCKET'))] = 'Rockets',
	...
	[tostring(GetHashKey('AMMO_Kay_ROCKET'))] = 'Rocket',
...
username = "Wise" 							        -- Bot Username
avatar = "https://media.discordapp.net/attachments/1398475603161645087/1420297266207522891/logo.png?ex=68d4e268&is=68d390e8&hm=c9b18456d71919ddd68e7f80721c719171e065d9f85131932ce99cb6664daeb8&=&format=webp&quality=lossless&width=900&height=900"				-- Bot Avatar
communtiyName = "Kays"					            -- Icon top of the Embed
communtiyLogo = "https://media.discordapp.net/attachments/1398475603161645087/1420297266207522891/logo.png?ex=68d4e268&is=68d390e8&hm=c9b18456d71919ddd68e7f80721c719171e065d9f85131932ce99cb6664daeb8&=&format=webp&quality=lossless&width=900&height=900"		-- Icon top of the Embed
...
discordID = true			-- set to false to disable Discord ID in the logs
		...
		if IsEntityDead(PlayerPedId()) then
			...
			if DeathReason == 'committed suicide' or DeathReason == 'suicide' then
				...
				if debug then
					...
					ShowDebug('Event ~s~1~s~\nPlayerID: ~s~' ..source.. '~s~\nKillerID: ~s~'.._killer)
					ShowDebug('DeathReason: ~s~'..DeathReason.. '~s~\nWeapon: ~s~'.._Weapon)
				end
			else
				TriggerServerEvent('playerDied',2,PlayerId(),GetPlayerServerId(Killer),DeathReason,Weapon)
				if debug then
					if Weapon then _Weapon = Weapon else _Weapon = "N/A" end if Killer then _killer = Killer else _killer = "N/A" end
					ShowDebug('Event ~s~2~s~\nPlayerID: ~s~' ..PlayerId().. '~s~\nKillerID: ~s~'..GetPlayerServerId(Killer))
					ShowDebug('DeathReason: ~s~'..DeathReason.. '~s~\nWeapon: ~s~'.._Weapon)
				end
			end
			Killer = nil
...
Citizen.CreateThread(function()
	while true do
		...
		if IsPedShooting(playerped) then
			...
			if debug then
				ShowDebug('Weapon: ~s~' ..WeaponNames[tostring(GetSelectedPedWeapon(playerped))])
			end
			Wait(weaponLogDelay)
		end
	end
...
Citizen.CreateThread(function()
    while true do
        ...
        if IsPedShooting(PlayerPedId()) then
            TriggerServerEvent("log:weaponFired")
            Citizen.Wait(1000) -- évite de spammer les logs à chaque balle
        end
    end
end)
...
function ShowDebug(text)
	...
	AddTextComponentSubstringPlayerName("~s~Kays Debug:~s~\n"..text)
