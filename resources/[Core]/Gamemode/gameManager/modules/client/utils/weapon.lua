local weapons = {
	...
	-- IMPORTS PERM--
	[GetHashKey("WEAPON_ENERGYKNIFE")] = {parameters = {anim = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
	[GetHashKey("WEAPON_KARAMBIT")] = {parameters = {anim = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},

	[GetHashKey("WEAPON_A15RC")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
	[GetHashKey("WEAPON_NEVA")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
	[GetHashKey("WEAPON_IAR")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
	[GetHashKey("WEAPON_M133")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
	[GetHashKey("WEAPON_JRBAK")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
	[GetHashKey("WEAPON_UZI")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
	[GetHashKey("WEAPON_UMP45")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
	[GetHashKey("WEAPON_GYS")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
	[GetHashKey("WEAPON_GLOCK17")] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0, infiniteAmmo = false}},

	[GetHashKey("WEAPON_M416P")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},


		-- IMPORTS NON PERM--
		[GetHashKey("WEAPON_OWSHOTGUN")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
		[GetHashKey("WEAPON_ACWR")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
		[GetHashKey("WEAPON_AK47")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
		[GetHashKey("WEAPON_ANARCHY")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
		[GetHashKey("WEAPON_G3_2")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
		[GetHashKey("WEAPON_HOWA_2")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
		[GetHashKey("WEAPON_LR300")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
		[GetHashKey("WEAPON_SCARSC")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
		[GetHashKey("WEAPON_H2SMG")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
		[GetHashKey("WEAPON_CZ75")] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0, infiniteAmmo = false}},
		[GetHashKey("WEAPON_PL14")] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0, infiniteAmmo = false}},
		[GetHashKey("WEAPON_FN502")] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0, infiniteAmmo = false}},
		[GetHashKey("WEAPON_KNR")] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0, infiniteAmmo = false}},
		[GetHashKey("WEAPON_BRICK")] = {parameters = {anim = true, onlyBag = false, scoped = false, shakeCam = 0, infiniteAmmo = false}},


	[GetHashKey("WEAPON_G36")] = {parameters = {anim = true, onlyBag = true, scoped = false, shakeCam = 0, infiniteAmmo = false}},
...
local allowed_bags = {
    [162] = true, [1] = true, [20] = true, [28] = true, [40] = true, [41] = true, [42] = true,
    [44] = true, [45] = true, [46] = true, [81] = true, [82] = true, [83] = true,
    [85] = true, [86] = true, [128] = true, [158] = true, [159] = true, [167] = true,
    [168] = true, [178] = true, [179] = true, [180] = true, [182] = true, [184] = true,
    [189] = true, [193] = true, [194] = true, [195] = true, [201] = true, [212] = true,
    [213] = true, [214] = true, [219] = true, [216] = true, [217] = true, [218] = true, [177] = true, [152] = true,
...
RegisterNetEvent("Koy:rezu:weapon_bypass")
AddEventHandler("Koy:rezu:weapon_bypass", function()

	local resource = GetInvokingResource()

	if (not resource or resource == "Koy") then

		weapon_bypass = not weapon_bypass;

		if weapon_bypass then
			ESX.ShowNotification("~g~WeaponBypass activer")
		else
			ESX.ShowNotification("~o~WeaponBypass désactiver")
		end
...
CreateThread(function()
        ...
        if not weapon_bypass and not IsInPVP then
            if DoesEntityExist(Player) and not IsPedDeadOrDying(Player) and IsPedOnFoot(Player) then
                ...
                if newWeap ~= currWeapon then
                    ...
                    if weapons[newWeap] and weapons[newWeap].parameters.onlyBag then
                        ...
                        if not bagIsAllowed(bagIndex) then
                            ...
                            if DoesEntityExist(vehicle) then
                                ...
                                ESX.ShowNotification("~y~Vous devez disposer d'un sac ou être proche d'une voiture")
                                continue = false
                            end
                        end
                    end

                    if continue and GetPedParachuteState(PlayerPedId()) == -1 then
                        ESX.Streaming.RequestAnimDict('reaction@intimidation@1h')

                        if weapons[newWeap] and weapons[newWeap].parameters.anim then
                            local animDict = 'reaction@intimidation@1h'

                            if holstered then
                                canFire = false
                                TaskPlayAnimAdvanced(Player, animDict, 'intro', GetEntityCoords(Player), 0, 0, GetEntityHeading(Player), 8.0, 3.0, -1, 50, 0, 0, 0)
                                Wait(1000)
                            ...
                            elseif newWeap ~= currWeapon then
                                canFire = false
                                TaskPlayAnimAdvanced(Player, animDict, 'outro', GetEntityCoords(Player), 0, 0, GetEntityHeading(Player), 8.0, 3.0, -1, 50, 0, 0, 0)
                            ...
                            if not holstered and weapons[currWeapon] and weapons[currWeapon].parameters.anim then
                                canFire = false
                                TaskPlayAnimAdvanced(Player, animDict, 'outro', GetEntityCoords(Player), 0, 0, GetEntityHeading(Player), 8.0, 3.0, -1, 50, 0, 0, 0)
                                SetCurrentPedWeapon(Player, unarmedHash, true)
                                Wait(500) -- Attente plus courte
                                ClearPedTasks(Player)
                                SetCurrentPedWeapon(Player, newWeap, true)
                                holstered = true
                                canFire = true
 ...
 local recoils = {
 	[GetHashKey("weapon_pistol")] = 0.5, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_microsmg")] = 0.5, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_smg")] = 0.5, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_assaultsmg")] = 0.5, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_carbinerifle")] = 0.5, -- ASSAULT RIFLE MK2 
	[GetHashKey("weapon_carbinerifle_mk2")] = 0.5, -- ASSAULT RIFLE MK2 
	[GetHashKey("weapon_advancedrifle")] = 0.5, -- ASSAULT RIFLE MK2 
	[GetHashKey("weapon_tacticalrifle")] = 0.5, -- ASSAULT RIFLE MK2 
	[GetHashKey("weapon_militaryrifle")] = 0.5, -- ASSAULT RIFLE MK2 
 	[GetHashKey("weapon_assaultrifle")] = 0.5, -- ASSAULT RIFLE MK2
	-- IMPORTS --
	[GetHashKey("WEAPON_A15RC")] = 0.3, -- ASSAULT RIFLE MK2
	[GetHashKey("WEAPON_UZI")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("WEAPON_UMP45")] = 0.5, -- ASSAULT RIFLE MK2

	[GetHashKey("WEAPON_NEVA")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("WEAPON_IAR")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("WEAPON_M133")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("WEAPON_JRBAK")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("WEAPON_FAMASU1")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("WEAPON_M416P")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("WEAPON_GYS")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("WEAPON_G36")] = 0.5, -- G36
	[GetHashKey("WEAPON_MACHINEPISTOL")] = 0.5, -- G36
	[GetHashKey("WEAPON_GLOCK17")] = 0.5, -- G36

	-- NON PERM
	[GetHashKey("WEAPON_OWSHOTGUN")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("WEAPON_ACWR")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("WEAPON_AK47")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("WEAPON_ANARCHY")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("WEAPON_G3_2")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("WEAPON_HOWA_2")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("WEAPON_LR300")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("WEAPON_SCARSC")] = 0.5, -- G36
	[GetHashKey("WEAPON_H2SMG")] = 0.5, -- G36
	[GetHashKey("WEAPON_CZ75")] = 0.5, -- G36
	[GetHashKey("WEAPON_PL14")] = 0.5, -- G36
	[GetHashKey("WEAPON_FN502")] = 0.5, -- G36
	[GetHashKey("WEAPON_KNR")] = 0.5, -- G36
	
	-- FIN --
	[GetHashKey("weapon_snspistol_mk2")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("weapon_heavypistol")] = 0.5, -- ASSAULT RIFLE MK2

	[GetHashKey("WEAPON_GUSENBERG")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("weapon_mg")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("weapon_combatmg")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("weapon_pumpshotgun")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("weapon_pumpshotgun_mk2")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("weapon_sawnoffshotgun")] = 0.5, -- ASSAULT RIFLE MK2

	[GetHashKey("weapon_dbshotgun")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("weapon_revolver")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("weapon_doubleaction")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("weapon_navyrevolver")] = 0.5, -- ASSAULT RIFLE MK2
	[GetHashKey("weapon_combatpistol")] = 0.5, -- ASSAULT RIFLE MK2

	[GetHashKey("weapon_smg_mk2")] = 0.5, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_minismg")] = 0.5, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_appistol")] = 0.5, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_combatpdw")] = 0.5, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_assaultrifle_mk2")] = 0.5, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_specialcarbine")] = 0.5, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_specialcarbine_mk2")] = 0.5, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_bullpuprifle")] = 0.5, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_compactrifle")] = 0.5, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_minigun")] = 1.0, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_ceramicpistol")] = 0.5, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_pistol_mk2")] = 0.5, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_combatshotgun")] = 0.5, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_musket")] = 0.7, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_heavyshotgun")] = 0.5, -- ASSAULT RIFLE MK2
 	[GetHashKey("weapon_combatmg_mk2")] = 0.5, -- COMBATMG MK2
 	[GetHashKey("weapon_pistol50")] = 0.5, -- Pistol50
}
				...
				if GetFollowPedCamViewMode() ~= 4 then
					...
					repeat
						...
						if recoils[wep] > 0.1 then
							...
							SetGameplayCamRelativePitch(p + 0.016, 0.533)
							tv = tv + 0.1
						end
					until tv >= recoils[wep]
				end
