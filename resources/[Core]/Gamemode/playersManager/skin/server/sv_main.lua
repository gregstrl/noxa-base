...
exports["Koy"]:RegisterCommand("skin", function(xPlayer, args)
	...
	if (xPlayer ~= nil) then
		xPlayer.showNotification(("Vous avez fait ouvrir le menu skin au joueur ~g~%s~s~."):format(player_selected_data.getName()))
	end
