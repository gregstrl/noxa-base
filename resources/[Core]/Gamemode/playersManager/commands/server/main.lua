...
RegisterNetEvent("Koy:UpdatePlayer", function()
	local src = source;
	local xPlayer = ESX.GetPlayerFromId(src);
	if (xPlayer) then
		xPlayer.triggerEvent('Koy:ReloadPlayer', {
...
exports["Koy"]:RegisterCommand("announce", function(xPlayer, args)
...
-- Kick
exports["Koy"]:RegisterCommand("kick", function(xPlayer, args)
	...
	if (xPlayer and not exports["Koy"]:GroupIsHigher(xPlayer.getGroup(), target_player_selected.getGroup())) then
		return
	end
	...
	SendLogs("Staff", "Koy | Kick", "Le staff **"..staffInfo.name.."** (***"..staffInfo.identifier.."***) vient de kick le joueur **"..target_player_selected.getName().."** (***"..target_player_selected.getIdentifier().."***) pour la raison [**"..kick_reason.."**]", "https://discord.com/api/webhooks/1258835549649899570/YxXxWpYHnFvLKc5zG0nidqGHAE2by8oRApYIkVoz_XaVn5cNE-VMFVxc2XmyO2aoussy")
