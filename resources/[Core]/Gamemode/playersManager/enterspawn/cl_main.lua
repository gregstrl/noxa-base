--[[
  This file is part of Wildback RolePlay.
  Copyright (c) Wildback RolePlay - All Rights Reserved
...
local function OpenMenuSpawn()
    ...
    while menu ~= nil do
        RageUI.IsVisible(menu, function()
            RageUI.Button("".. GetPlayerName(PlayerId()) .."", nil, {RightLabel = "~g~Sélectionner"}, true, {
                onSelected = function()
                    SpawnEntrer()
                end
            })
...
function SpawnEntrer()
    ...
    Wait(3000);
    RageUI.CloseAll();
    ESX.ShowNotification("Bon retour parmis nous ! Nous vous souhaitons un bon jeu sur notre serveur")
    destorycam();
