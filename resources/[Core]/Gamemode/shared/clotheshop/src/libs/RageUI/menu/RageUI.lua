...
RageUIClothes.Settings = {
    ...
    Items = {
        ...
        Background = { Dictionary = "k2r", Texture = "gradient_bgd", Y = 0, Width = 431 },
        Navigation = {
            Rectangle = { Width = 431, Height = 18 },
            Offset = 5,
            Arrows = { Dictionary = "k2r", Texture = "shop_arrows_upanddown", X = 190, Y = -6, Width = 50, Height = 50 },
        },
        Description = {
            Bar = { Y = 4, Width = 431, Height = 4 },
            Background = { Dictionary = "k2r", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 30 },
            Text = { X = 8, Y = 10, Scale = 0.35 },
        },
    },
    Panels = {
        Grid = {
            Background = { Dictionary = "k2r", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 275 },
        ...
        Percentage = {
            Background = { Dictionary = "k2r", Texture = "gradient_bgd", Y = 4, Width = 431, Height = 76 },
        ...
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            if CurrentMenu.Sprite ~= nil then
                if CurrentMenu.Sprite.Dictionary ~= nil then
                    if CurrentMenu.Sprite.Dictionary == "k2r" then
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Subtitle) then
            ...
            if CurrentMenu.Subtitle ~= "" then
                RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUIClothes.ItemOffset, RageUIClothes.Settings.Items.Subtitle.Background.Width + CurrentMenu.WidthOffset, RageUIClothes.Settings.Items.Subtitle.Background.Height + CurrentMenu.SubtitleHeight, 17, 17, 17, 255)
...
function RageUIClothes.Description()
    ...
    if CurrentMenu ~= nil and CurrentMenu.Description ~= nil then
        if CurrentMenu() then
            RageUIClothes.ItemsSafeZone(CurrentMenu)
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + Description.Bar.Y + CurrentMenu.SubtitleHeight + RageUIClothes.ItemOffset, Description.Bar.Width + CurrentMenu.WidthOffset, Description.Bar.Height, 17, 17, 17, 255)
            RenderSprite(Description.Background.Dictionary, Description.Background.Texture, CurrentMenu.X, CurrentMenu.Y + Description.Background.Y + CurrentMenu.SubtitleHeight + RageUIClothes.ItemOffset, Description.Background.Width + CurrentMenu.WidthOffset, CurrentMenu.DescriptionHeight, 17, 17, 17, 255)
