...
function RageUIClothes.PercentagePanel(Percent, HeaderText, MinText, MaxText, Action, Index)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (Index == nil or (CurrentMenu.Index == Index)) then
            ...
            RenderSprite(Percentage.Background.Dictionary, Percentage.Background.Texture, CurrentMenu.X, CurrentMenu.Y + Percentage.Background.Y + CurrentMenu.SubtitleHeight + RageUIClothes.ItemOffset, Percentage.Background.Width + CurrentMenu.WidthOffset, Percentage.Background.Height)
            RenderRectangle(CurrentMenu.X + Percentage.Bar.X + (CurrentMenu.WidthOffset / 2), CurrentMenu.Y + Percentage.Bar.Y + CurrentMenu.SubtitleHeight + RageUIClothes.ItemOffset, Percentage.Bar.Width, Percentage.Bar.Height, 87, 87, 87, 255)
            RenderRectangle(CurrentMenu.X + Percentage.Bar.X + (CurrentMenu.WidthOffset / 2), CurrentMenu.Y + Percentage.Bar.Y + CurrentMenu.SubtitleHeight + RageUIClothes.ItemOffset, Progress, Percentage.Bar.Height, 245, 245, 245, 255)
...
function RageUIClothes.PercentagePanelSpawn(Percent, HeaderText, MinText, MaxText, Action, Index)
    local CurrentMenu = RageUIClothes.CurrentMenu
...
function RageUIClothes.PercentagePanelSpawn(Percent, HeaderText, MinText, MaxText, Callback, Index)
    local CurrentMenu = RageUIClothes.CurrentMenu
