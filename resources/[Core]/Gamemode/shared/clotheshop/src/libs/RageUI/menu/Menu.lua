...
function RageUIClothes.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.Index = 1
    Menu.Sprite = { Dictionary = TextureDictionary or "k2r", Texture = TextureName or "interaction_bgd", Color = { R = R, G = G, B = B, A = A } }
    Menu.Rectangle = nil
...
function RageUIClothes.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    if ParentMenu ~= nil then
        if ParentMenu() then
            local Menu = RageUIClothes.CreateMenu(Title or ParentMenu.Title, Subtitle or string.upper(ParentMenu.Subtitle), X or ParentMenu.X, Y or ParentMenu.Y)
...
---@return nil
---@public
function RageUIClothes.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + RageUIClothes.Settings.Items.Subtitle.Text.X, self.Y + RageUIClothes.Settings.Items.Subtitle.Text.Y, 0, RageUIClothes.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIClothes.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function RageUIClothes.Menus:SetPageCounter(Subtitle)
