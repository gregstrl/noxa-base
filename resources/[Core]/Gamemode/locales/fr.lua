...
Locales['fr'] = {
	...
	['robbery_complete_at'] = '~s~ Braquage terminé à: ~g~',
	...
	['field'] = 'Pressez ~y~E~s~ pour ~s~voler~s~ les bijoux',
	['collectinprogress'] = 'récupération des bijoux en cours...',
	['lester'] = '~g~Vous avez braqué la bijouterie! Maintenant, revendez les bijoux !',
	--Proprety
	['have_withdrawn'] = 'vous avez pris ~y~x%s~s~ ~g~%s~s~',
	['have_deposited'] = 'vous avez déposé ~y~x%s~s~ ~s~%s~s~',
	...
	['yes']                    = 'oui',
	['you_have']               = 'vous avez ~g~$%s~s~ en attente de ~s~blanchiement~s~ (24h).',
	['you_have_laundered']     = 'vous avez ~s~blanchi~s~ votre argent : ~g~$%s~s~',
	...
	['act_imp_police'] = 'action ~s~impossible~s~, ~g~policiers~s~: ~g~%s~s~/~y~%s~s~ online',
	...
	--Logger
	['server'] = 'Oeil de Fowlmas',
	['server_start'] = 'le serveur a été redémarré',
	['server_chat'] = 'chat',

	['server_connecting'] = 'Oeil de Fowlmas',
	...
	['server_washingmoney'] = 'Oeil de Fowlmas';
	...
	['used_chaklik'] = 'Vous avez mangé un ~g~Chaklik~s~',
	['used_bœuf_stroganov'] = 'Vous avez mangé un ~g~Bœuf Stroganov~s~',
	['used_pate_au_truffe'] = 'Vous avez mangé des ~g~Pates Au Truffe~s~',
	['used_riz'] = 'Vous avez mangé du ~g~Riz~s~',
	['used_entrecôte'] = 'Vous avez mangé une ~g~Entrecôte~s~',
	['used_homard_grillé'] = 'Vous avez mangé un ~g~Homard Grillé~s~',
	['used_carpaccio_de_flétan'] = 'Vous avez mangé un ~g~Carpaccio De Flétan~s~',
	['used_salade_césar'] = 'Vous avez mangé une ~g~Salade César~s~',
	['used_crêpes'] = 'Vous avez mangé une ~g~crêpe~s~',
	['used_medovik'] = 'Vous avez mangé un ~g~Medovik~s~',
	...
	['paid_invoice'] = 'vous avez ~g~payé~s~ une facture de ~s~$%s~s~',
  ...
  -- Cosmetics
	...
	['cartEmptyTxt'] = 'Il n\'y a pas d\'articles dans le panier!',
		...
		['auto_fine_notif'] = 'Excès de vitesse: ~g~%sKm/h ~s~au lieu de ~g~%sKm/h.',
		
		['police_call'] = '~y~Excès de vitesse majeur sur ',
		
		['received_invoice'] = 'Vous avez ~reçu~s~ une facture de %s~g~$',
