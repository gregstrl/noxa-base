...
RegisterNetEvent("RageUIv5:Popup")
AddEventHandler("RageUIv5:Popup", function(array)
    RageUIv5.Popup(array)
end)

---Popup
---@param array table
---@public
function RageUIv5.Popup(array)
    ClearPrints()
...
---@param array table
---@public
function RageUIv5.PopupChar(array)
    if (array.colors == nil) then
        SetNotificationBackgroundColor(140)
    else
        SetNotificationBackgroundColor(array.colors)
