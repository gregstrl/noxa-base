...
---@return table
---@public
function RageUIv5.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = RageUIv5.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = 100
    Menu.Open = false
    Menu.Controls = RageUIv5.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + RageUIv5.Settings.Items.Subtitle.Text.X, Menu.Y + RageUIv5.Settings.Items.Subtitle.Text.Y, 0, RageUIv5.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIv5.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, RageUIv5.Menus)
end
...
---@return table
---@public
function RageUIv5.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
...
---@return nil
---@public
function RageUIv5.Menus:SetTitle(Title)
    self.Title = Title
end
...
---@return nil
---@public
function RageUIv5.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function RageUIv5.Menus:GetStyleSize()
...
---@return void
---@public
function RageUIv5.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function RageUIv5.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function RageUIv5.Menus:UpdateCursorStyle()
...
---@return void
---@public
function RageUIv5.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function RageUIv5.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + RageUIv5.Settings.Items.Subtitle.Text.X, self.Y + RageUIv5.Settings.Items.Subtitle.Text.Y, 0, RageUIv5.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIv5.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function RageUIv5.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function RageUIv5.Menus:EditSpriteColor(color)
...
---@return nil
---@public
function RageUIv5.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function RageUIv5.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function RageUIv5.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function RageUIv5.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function RageUIv5.Menus:Closable(boolean)
...
function RageUIv5.Menus:AddInstructionButton(button)
...
function RageUIv5.Menus:RemoveInstructionButton(button)
...
function RageUIv5.Menus:UpdateInstructionalButtons(Visible)
