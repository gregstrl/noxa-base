        ...
        if Enabled == true then
            ...
            if RageUIv5.CurrentMenu ~= nil then
                if RageUIv5.CurrentMenu() then
                    ...
                    --if (RageUIv5.CurrentMenu.WidthOffset == 100) then
                        if Glare then
							...
							---@type number
							local Glarewidth = RageUIv5.Settings.Items.Title.Background.Width

							---@type number
							local Glareheight = RageUIv5.Settings.Items.Title.Background.Height
							---@type number
							local GlareX = RageUIv5.CurrentMenu.X / 1860 + (RageUIv5.CurrentMenu.SafeZoneSize.X / (64.399 - (RageUIv5.CurrentMenu.WidthOffset * 0.065731)))
                            ---@type number
                            local GlareY = RageUIv5.CurrentMenu.Y / 1080 + RageUIv5.CurrentMenu.SafeZoneSize.Y / 33.195020746888
                            RageUIv5.SetScaleformParams(ScaleformMovie, {
