...
function RageUIv1.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.Display.BackgroundItemsColor = {r = 0, g = 0, b = 0, a = 112};
    Menu.Display.BackgroundColor = {r = 0, g = 0, b = 0, a = 110};
...
function RageUIv1.Menus:SetSubtitle(title)
...
---@return nil
---@public
function RageUIv1.Menus:SetPageCounter(Subtitle)
