...
---@return nil
---@public
function RageUICustom.GoUp(Options)
    ...
    if CurrentMenu ~= nil then
        ...
        if CurrentMenu() then
            if (Options ~= 0) then
                ...
                local Audio = RageUICustom.Settings.Audio
                RageUICustom.PlaySound(Audio[Audio.Use].Error.audioName, Audio[Audio.Use].Error.audioRef)
            end
        end
    end
end
...
---@return nil
---@public
function RageUICustom.GoDown(Options)
    local CurrentMenu = RageUICustom.CurrentMenu;
    if CurrentMenu ~= nil then
        Options = CurrentMenu.Options
        if CurrentMenu() then
...
function RageUICustom.GoActionControl(Controls, Action)
...
function RageUICustom.GoActionControlSlider(Controls, Action)
...
---@return nil
---@public
function RageUICustom.Controls()
    local CurrentMenu = RageUICustom.CurrentMenu;
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            if CurrentMenu.Open then
                ...
                RageUICustom.Options = CurrentMenu.Options
                ...
                for i = 1, #ControlActions do
                    RageUICustom.GoActionControl(Controls, ControlActions[i])
                end

                RageUICustom.GoActionControlSlider(Controls, 'SliderLeft')
                RageUICustom.GoActionControlSlider(Controls, 'SliderRight')
...
---@return nil
---@public
function RageUICustom.Navigation()
    local CurrentMenu = RageUICustom.CurrentMenu;
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Navigation) then
            ...
            if RageUICustom.Options > CurrentMenu.Pagination.Total then
                ...
                if CurrentMenu.EnableMouse then
                    UpHovered = RageUICustom.IsMouseInBounds(CurrentMenu.X + CurrentMenu.SafeZoneSize.X, CurrentMenu.Y + CurrentMenu.SafeZoneSize.Y + CurrentMenu.SubtitleHeight + RageUICustom.ItemOffset, RageUICustom.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUICustom.Settings.Items.Navigation.Rectangle.Height)
                    DownHovered = RageUICustom.IsMouseInBounds(CurrentMenu.X + CurrentMenu.SafeZoneSize.X, CurrentMenu.Y + RageUICustom.Settings.Items.Navigation.Rectangle.Height + CurrentMenu.SafeZoneSize.Y + CurrentMenu.SubtitleHeight + RageUICustom.ItemOffset, RageUICustom.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUICustom.Settings.Items.Navigation.Rectangle.Height)

                    if CurrentMenu.Controls.Click.Active then
                        if UpHovered then
                            RageUICustom.GoUp(RageUICustom.Options)
                        elseif DownHovered then
                            RageUICustom.GoDown(RageUICustom.Options)
                        end
                    end

                    if UpHovered then
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y + CurrentMenu.SubtitleHeight + RageUICustom.ItemOffset, RageUICustom.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUICustom.Settings.Items.Navigation.Rectangle.Height, 30, 30, 30, 255)
                    else
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y + CurrentMenu.SubtitleHeight + RageUICustom.ItemOffset, RageUICustom.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUICustom.Settings.Items.Navigation.Rectangle.Height, 0, 0, 0, 200)
                    end

                    if DownHovered then
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUICustom.Settings.Items.Navigation.Rectangle.Height + CurrentMenu.SubtitleHeight + RageUICustom.ItemOffset, RageUICustom.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUICustom.Settings.Items.Navigation.Rectangle.Height, 30, 30, 30, 255)
                    else
                        RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUICustom.Settings.Items.Navigation.Rectangle.Height + CurrentMenu.SubtitleHeight + RageUICustom.ItemOffset, RageUICustom.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUICustom.Settings.Items.Navigation.Rectangle.Height, 0, 0, 0, 200)
                    end
                else
                    RenderRectangle(CurrentMenu.X, CurrentMenu.Y + CurrentMenu.SubtitleHeight + RageUICustom.ItemOffset, RageUICustom.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUICustom.Settings.Items.Navigation.Rectangle.Height, 0, 0, 0, 200)
                    RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUICustom.Settings.Items.Navigation.Rectangle.Height + CurrentMenu.SubtitleHeight + RageUICustom.ItemOffset, RageUICustom.Settings.Items.Navigation.Rectangle.Width + CurrentMenu.WidthOffset, RageUICustom.Settings.Items.Navigation.Rectangle.Height, 0, 0, 0, 200)
                end
                RenderSprite(RageUICustom.Settings.Items.Navigation.Arrows.Dictionary, RageUICustom.Settings.Items.Navigation.Arrows.Texture, CurrentMenu.X + RageUICustom.Settings.Items.Navigation.Arrows.X + (CurrentMenu.WidthOffset / 2), CurrentMenu.Y + RageUICustom.Settings.Items.Navigation.Arrows.Y + CurrentMenu.SubtitleHeight + RageUICustom.ItemOffset, RageUICustom.Settings.Items.Navigation.Arrows.Width, RageUICustom.Settings.Items.Navigation.Arrows.Height)
                RageUICustom.ItemOffset = RageUICustom.ItemOffset + (RageUICustom.Settings.Items.Navigation.Rectangle.Height * 2)
            end
        end
    end
end
