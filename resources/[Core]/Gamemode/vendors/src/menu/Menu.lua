...
---@return table
---@public
function RageUIc.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = RageUIc.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = RageUIc.UI.Style[RageUIc.UI.Current].Width
    Menu.Open = false
    Menu.Controls = RageUIc.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + RageUIc.Settings.Items.Subtitle.Text.X, Menu.Y + RageUIc.Settings.Items.Subtitle.Text.Y, 0, RageUIc.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIc.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, RageUIc.Menus)
end
...
---@return table
---@public
function RageUIc.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
...
---@return nil
---@public
function RageUIc.Menus:SetTitle(Title)
    self.Title = Title
end
...
---@return nil
---@public
function RageUIc.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function RageUIc.Menus:GetStyleSize()
...
---@return void
---@public
function RageUIc.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function RageUIc.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function RageUIc.Menus:UpdateCursorStyle()
...
---@return void
---@public
function RageUIc.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function RageUIc.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + RageUIc.Settings.Items.Subtitle.Text.X, self.Y + RageUIc.Settings.Items.Subtitle.Text.Y, 0, RageUIc.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIc.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function RageUIc.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function RageUIc.Menus:EditSpriteColor(color)
...
---@return nil
---@public
function RageUIc.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function RageUIc.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function RageUIc.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function RageUIc.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function RageUIc.Menus:Closable(boolean)
...
function RageUIc.Menus:AddInstructionButton(button)
...
function RageUIc.Menus:RemoveInstructionButton(button)
...
function RageUIc.Menus:UpdateInstructionalButtons(Visible)
