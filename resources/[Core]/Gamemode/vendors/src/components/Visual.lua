...
RegisterNetEvent("RageUIc:Popup")
AddEventHandler("RageUIc:Popup", function(array)
    RageUIc.Popup(array)
end)
...
---@param array table
---@public
function RageUIc.PopupChar(array)
    if (array.colors == nil) then
        SetNotificationBackgroundColor(140)
    else
        SetNotificationBackgroundColor(array.colors)
