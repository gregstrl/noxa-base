    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            if (CurrentMenu.Display.Glare) then
                ...
                ---@type number
                local Glareheight = RageUIv4.Settings.Items.Title.Background.Height + 1.5
                ---@type number
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Subtitle) then
            ...
            if CurrentMenu.Subtitle ~= "" then
                RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUIv4.ItemOffset, RageUIv4.Settings.Items.Subtitle.Background.Width + CurrentMenu.WidthOffset, RageUIv4.Settings.Items.Subtitle.Background.Height + CurrentMenu.SubtitleHeight, 18, 22, 24, 150)
...
function RageUIv4.Background()
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Background) then
            ...
            -- RenderSprite(RageUIv4.Settings.Items.Background.Dictionary, RageUIv4.Settings.Items.Background.Texture, CurrentMenu.X, CurrentMenu.Y + RageUIv4.Settings.Items.Background.Y + CurrentMenu.SubtitleHeight, RageUIv4.Settings.Items.Background.Width + CurrentMenu.WidthOffset, RageUIv4.ItemOffset, 0, 18, 22, 24, 255)

            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + RageUIv4.Settings.Items.Background.Y + CurrentMenu.SubtitleHeight, RageUIv4.Settings.Items.Background.Width + CurrentMenu.WidthOffset, RageUIv4.ItemOffset + 7, 1, 1, 1, 140)
...
function RageUIv4.Description()
    ...
    if CurrentMenu ~= nil and CurrentMenu.Description ~= nil then
        if CurrentMenu() then
            RageUIv4.ItemsSafeZone(CurrentMenu)
            RenderRectangle(CurrentMenu.X, CurrentMenu.Y + Description.Background.Y + CurrentMenu.SubtitleHeight + RageUIv4.ItemOffset + 5, Description.Background.Width + CurrentMenu.WidthOffset, CurrentMenu.DescriptionHeight, 1, 1, 1, 140)
...
function RageUIv4.ItemsDescription(CurrentMenu, Description, Selected)
    ...
    if Description ~= "" or Description ~= nil then
        ...
        if Selected and CurrentMenu.Description ~= Description then
            ...
            ---@type number
            local DescriptionLineCount = GetLineCount(CurrentMenu.Description, CurrentMenu.X + SettingsDescription.Text.X, CurrentMenu.Y + SettingsDescription.Text.Y + CurrentMenu.SubtitleHeight + RageUIv4.ItemOffset, 0, SettingsDescription.Text.Scale, 18, 22, 24, 1, nil, false, false, SettingsDescription.Background.Width + (CurrentMenu.WidthOffset - 5.0))
