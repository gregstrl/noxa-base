function RageUIMasques.Info(Title, RightText, LeftText)
    ...
    RenderRectangle(332 + 10 + 100, 0, 332 + 50, Title ~= nil and 50 + (LineCount * 20) or ((LineCount + 1) * 20), 1, 1, 1, 140)
end

--RageUIMasques.Info("Titre", {"Sous titre 1", "Sous titre 2", "Sous titre 3","Sous titre 4"}, {"Sous titre droite 1", "Sous titre droite 2", "Sous titre droite 3","Sous titre droite 4" })