...
RegisterNetEvent("RageUIv3:Popup")
AddEventHandler("RageUIv3:Popup", function(array)
    RageUIv3.Popup(array)
end)

---Popup
---@param array table
---@public
function RageUIv3.Popup(array)
    ClearPrints()
...
---@param array table
---@public
function RageUIv3.PopupChar(array)
    if (array.colors == nil) then
        SetNotificationBackgroundColor(140)
    else
        SetNotificationBackgroundColor(array.colors)
