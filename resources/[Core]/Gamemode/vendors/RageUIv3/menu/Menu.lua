...
---@param B number
---@param A number
---@return RageUIv3Menus
---@public
function RageUIv3.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = RageUIv3.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = RageUIv3.UI.Style[RageUIv3.UI.Current].Width
    Menu.Open = false
    Menu.Controls = RageUIv3.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + RageUIv3.Settings.Items.Subtitle.Text.X, Menu.Y + RageUIv3.Settings.Items.Subtitle.Text.Y, 0, RageUIv3.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIv3.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, RageUIv3.Menus)
end
...
---@return RageUIv3Menus
---@public
function RageUIv3.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    if ParentMenu ~= nil then
        if ParentMenu() then
            local Menu = RageUIv3.CreateMenu(Title or ParentMenu.Title, Subtitle or ParentMenu.Subtitle, X or ParentMenu.X, Y or ParentMenu.Y)
...
---@return nil
---@public
function RageUIv3.Menus:SetTitle(Title)
    self.Title = Title
end

function RageUIv3.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function RageUIv3.Menus:GetStyleSize()
...
---@return void
---@public
function RageUIv3.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function RageUIv3.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function RageUIv3.Menus:UpdateCursorStyle()
...
---@return void
---@public
function RageUIv3.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function RageUIv3.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + RageUIv3.Settings.Items.Subtitle.Text.X, self.Y + RageUIv3.Settings.Items.Subtitle.Text.Y, 0, RageUIv3.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIv3.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function RageUIv3.Menus:SetPageCounter(Subtitle)
    self.PageCounter = Subtitle
end

function RageUIv3.Menus:SetSizeWidth(Value)
    local witdh
...
---@return nil
---@public
function RageUIv3.Menus:EditSpriteColor(R, G, B, A)
...
---@return nil
---@public
function RageUIv3.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function RageUIv3.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function RageUIv3.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function RageUIv3.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function RageUIv3.Menus:Closable(boolean)
...
function RageUIv3.Menus:AddInstructionButton(button)
...
function RageUIv3.Menus:RemoveInstructionButton(button)
...
function RageUIv3.Menus:UpdateInstructionalButtons(Visible)
