...
---@return RageUIMenus
---@public
function RageUIDeath.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.DescriptionHeight = RageUIDeath.Settings.Items.Description.Background.Height
    Menu.X = X or 0
    Menu.Y = Y or 0
    Menu.Parent = nil
    Menu.WidthOffset = RageUIDeath.UI.Style[RageUIDeath.UI.Current].Width
    Menu.Open = false
    Menu.Controls = RageUIDeath.Settings.Controls
    Menu.Index = 1
    ...
    if Menu.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(Menu.Subtitle, Menu.X + RageUIDeath.Settings.Items.Subtitle.Text.X, Menu.Y + RageUIDeath.Settings.Items.Subtitle.Text.Y, 0, RageUIDeath.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIDeath.Settings.Items.Subtitle.Background.Width + Menu.WidthOffset)
    ...
    return setmetatable(Menu, RageUIDeath.Menus)
end
...
---@return RageUIMenus
---@public
function RageUIDeath.CreateSubMenu(ParentMenu, Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    if ParentMenu ~= nil then
        if ParentMenu() then
            local Menu = RageUIDeath.CreateMenu(Title or ParentMenu.Title, Subtitle or ParentMenu.Subtitle, X or ParentMenu.X, Y or ParentMenu.Y)
...
function RageUIDeath.Menus:DisplayHeader(boolean)
    self.Display.Header = boolean;
    return self.Display.Header;
end

function RageUIDeath.Menus:DisplayGlare(boolean)
    self.Display.Glare = boolean;
    return self.Display.Glare;
end

function RageUIDeath.Menus:DisplaySubtitle(boolean)
    self.Display.Subtitle = boolean;
    return self.Display.Subtitle;
end

function RageUIDeath.Menus:DisplayNavigation(boolean)
    self.Display.Navigation = boolean;
    return self.Display.Navigation;
end

function RageUIDeath.Menus:DisplayInstructionalButton(boolean)
    self.Display.InstructionalButton = boolean;
    return self.Display.InstructionalButton;
end

function RageUIDeath.Menus:DisplayPageCounter(boolean)
...
---@return nil
---@public
function RageUIDeath.Menus:SetTitle(Title)
    self.Title = Title
end

function RageUIDeath.Menus:SetStyleSize(Value)
    local witdh
...
---@return any
---@public
function RageUIDeath.Menus:GetStyleSize()
...
---@return void
---@public
function RageUIDeath.Menus:SetCursorStyle(Int)
...
---@return void
---@public
function RageUIDeath.Menus:ResetCursorStyle()
    self.CursorStyle = 1
...
---@return void
---@public
function RageUIDeath.Menus:UpdateCursorStyle()
...
---@return void
---@public
function RageUIDeath.Menus:RefreshIndex()
    self.Index = 1
end
...
---@return nil
---@public
function RageUIDeath.Menus:SetSubtitle(Subtitle)
    ...
    if self.Subtitle ~= "" then
        local SubtitleLineCount = GetLineCount(self.Subtitle, self.X + RageUIDeath.Settings.Items.Subtitle.Text.X, self.Y + RageUIDeath.Settings.Items.Subtitle.Text.Y, 0, RageUIDeath.Settings.Items.Subtitle.Text.Scale, 245, 245, 245, 255, nil, false, false, RageUIDeath.Settings.Items.Subtitle.Background.Width + self.WidthOffset)
...
---@return nil
---@public
function RageUIDeath.Menus:SetPageCounter(Subtitle)
...
---@return nil
---@public
function RageUIDeath.Menus:EditSpriteColor(R, G, B, A)
...
---@return nil
---@public
function RageUIDeath.Menus:SetPosition(X, Y)
...
---@return nil
---@public
function RageUIDeath.Menus:SetTotalItemsPerPage(Value)
...
---@return nil
---@public
function RageUIDeath.Menus:SetRectangleBanner(R, G, B, A)
...
---@return nil
---@public
function RageUIDeath.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end

function RageUIDeath.Menus:Closable(boolean)
...
function RageUIDeath.Menus:AddInstructionButton(button)
...
function RageUIDeath.Menus:RemoveInstructionButton(button)
...
function RageUIDeath.Menus:UpdateInstructionalButtons(Visible)
