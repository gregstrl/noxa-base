...
Shared.Events:OnNet(Enums.Pound.Events.TakeVehicle, function(xPlayer, vehiclePlate)
    ...
    xPlayer.updateVIP(function(vip_level)
        ...
        if (account) then
            ...
            local price_to_pay = (type(vip_level) == "number" and (vip_level == 2 or vip_level == 3)) and 0 or Config["Pound"]["Prices"]["SpawnVehicle"]
...
Shared.Events:OnNet(Enums.Pound.Events.StoreVehicle, function(xPlayer, vehiclePlate)
    ...
    xPlayer.updateVIP(function(vip_level)
        ...
        if (account) then
            ...
            local price_to_pay = (type(vip_level) == "number" and (vip_level == 2 or vip_level == 3)) and 0 or Config["Pound"]["Prices"]["StoreVehicle"]
