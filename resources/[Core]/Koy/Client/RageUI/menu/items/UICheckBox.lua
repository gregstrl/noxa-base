...
local SettingsButton = {
    ...
    Text = { X = 20, Y = 7, Scale = 0.25 },
    LeftBadge = { Y = -2, X = 10, Width = 40, Height = 40 },
    RightBadge = { X = 300, Y = 1, Width = 30, Height = 30 },
    RightText = { X = 330, Y = 3, Scale = 0.25},
                    ...
                    if Style.Enabled == true or Style.Enabled == nil then
                        ...
                        if type(Style) == 'table' then
                            if Style.LeftBadge ~= RageUI.BadgeStyle.None then
                                ...
                                RenderSprite(BadgeData.BadgeDictionary or "commonmenu", BadgeData.BadgeTexture or "", CurrentMenu.X + SettingsButton.LeftBadge.X, CurrentMenu.Y - 0.6 + SettingsButton.LeftBadge.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, SettingsButton.LeftBadge.Width, SettingsButton.LeftBadge.Height, 0, BadgeData.BadgeColour and BadgeData.BadgeColour.R or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.G or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.B or 255, BadgeData.BadgeColour and BadgeData.BadgeColour.A or 255)
                            end
