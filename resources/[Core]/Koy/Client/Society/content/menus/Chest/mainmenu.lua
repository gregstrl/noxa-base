                        ...
                        Items:Button(weapon.label, description, {
                            ...
                            onSelected = function()
                                ...
                                if (Client.Player:GetWeaponsOfType(group) > 1) then
                                    ...
                                    local quantity = Shared:KeyboardInput(Shared.Lang:Translate("society_menu_chest_select_quantity", Shared:ServerColor(), Client.Player:GetAmmoForWeaponType(weaponType) or "~s~ERROR~s~"), 50);
