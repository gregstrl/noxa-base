--[[
----
----Created Date: 3:22 Friday October 14th 2022
----Author: Koy
----Made with ❤
----
----File: [Zone]
...
Zone = Class.new(function(class)
    ...
    function self:Constructor(id, data)
        ...
        if not id or type(id) ~= "string" then return error(("^4Koy %s^7: ^3Zone^7 | ^1 Id must be a string^7"):format(GetCurrentResourceName())) end
        self.id = id
        self.data = {
            job = data.job or "not",
