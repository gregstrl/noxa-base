    ...
    if (player_vehicle == nil) then
        ...
        if (player_vehicle_fuel ~= nil) then
            ...
            if (player_vehicle_fuel_rounded <= 90.0) then
                ...
                Items:SliderProgress(("Nombre de litre (%sL)"):format(fuel_liter_choose_current), fuel_liter_choose_current, fuel_liter_choose_max, "Nombre de litre que vous voulez ajouter au ~g~réservoir~s~.", {
                ...
                Items:Button("Confirmer", ("~g~%sL~s~ d'essence"):format(fuel_liter_choose_current), {
