...
supremacy_menu:IsVisible(function(Items)
    ...
    local hasAnnouncementPermission = Client.Admin:GroupHasPermission(client_player.group, "faire_annonce") == true or Client.Admin:GroupHasPermission(client_player.group, "make_announce") == true
    
    if hasAnnouncementPermission then
        Items:Button("Faire une Annonce", nil, {}, true, {
            onSelected = function()
