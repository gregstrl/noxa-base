...
Enums.Weapons = {
    ...
    ByType = {
        ...
        assault_rifles = {
            ...
            -- PERM
            WEAPON_A15RC = GetHashKey("A15RC"),
            WEAPON_NEVA = GetHashKey("NEVA"),
            WEAPON_GYS = GetHashKey("GYS"),
            WEAPON_IAR = GetHashKey("IAR"),
            WEAPON_M133 = GetHashKey("M133"),
            WEAPON_JRBAK = GetHashKey("JRBAK"),
            WEAPON_FAMASU1 = GetHashKey("FAMASU1"),
            WEAPON_UMP45 = GetHashKey("UMP45"),
            WEAPON_UZI = GetHashKey("UZI"),
            WEAPON_ENERGYKNIFE = GetHashKey("ENERGYKNIFE"),
            WEAPON_KARAMBIT = GetHashKey("KARAMBIT"),
            WEAPON_M416P = GetHashKey("M416P"),

                 -- ARME NON PERM
                WEAPON_OWSHOTGUN = GetHashKey("OWSHOTGUN"),
                WEAPON_ACWR = GetHashKey("ACWR"),
                WEAPON_AK47 = GetHashKey("AK47"),
                WEAPON_ANARCHY = GetHashKey("ANARCHY"),
                WEAPON_G3_2 = GetHashKey("G32"),
                WEAPON_HOWA_2 = GetHashKey("HOWA2"),
                WEAPON_LR300 = GetHashKey("LR300"),
                WEAPON_SCARSC = GetHashKey("SCARSC"),
                WEAPON_H2SMG = GetHashKey("H2SMG"),
                WEAPON_CZ75 = GetHashKey("CZ75"),
                WEAPON_PL14 = GetHashKey("PL14"),
                WEAPON_FN502 = GetHashKey("FN502"),
                WEAPON_KNR = GetHashKey("KNR"),
            
                WEAPON_BRICK = GetHashKey("BRICK"),
            -- FIN PERM    
