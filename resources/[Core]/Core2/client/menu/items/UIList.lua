local SettingsButton = {
    ...
    Text = { X = 30, Y = 5, Scale = 0.25 },
    LeftBadge = { Y = -2, Width = 40, Height = 40 },
    RightBadge = { X = 385, Y = -2, Width = 40, Height = 40 },
    RightText = { X = 405, Y = 4, Scale = 0.25 },
    SelectedSprite = { Dictionary = "k2r.ytd", Texture = "gradient_nav", Y = 0, Width = 431, Height = 38 },
}

---@type table
local SettingsList = {
    LeftArrow = { Dictionary = "k2r.ytd", Texture = "arrowleft", X = 378, Y = 3, Width = 30, Height = 30 },
    RightArrow = { Dictionary = "k2r.ytd", Texture = "arrowright", X = 400, Y = 3, Width = 30, Height = 30 },
