...
local Slider = {
	Background = { Dictionary = "k2r", Texture = "gradient_bgd", Y = 0, Width = 431, Height = 76 },
	Text = {
	...
	LeftArrow = { Dictionary = "k2r", Texture = "arrowleft", X = 12, Y = 29, Width = 25, Height = 25 },
	RightArrow = { Dictionary = "k2r", Texture = "arrowright", X = 389, Y = 29, Width = 25, Height = 25 },
}
...
function RageUI.SliderPanel(Value, MinValue, UpperText, MaxValue, Actions, Index)
	...
	if CurrentMenu ~= nil then
		if CurrentMenu() and ((CurrentMenu.Index == Index)) then
			...
			RenderSprite("k2r", "gradient_bgd", CurrentMenu.X, CurrentMenu.Y + Slider.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, Slider.Background.Width + CurrentMenu.WidthOffset, Slider.Background.Height, 0.0, 255, 255, 255, 255)
