...
local SettingsSlider = {
    ...
    LeftArrow = { Dictionary = "k2r", Texture = "arrowleft", X = 235, Y = 11.5, Width = 15, Height = 15 },
    RightArrow = { Dictionary = "k2r", Texture = "arrowright", X = 400, Y = 11.5, Width = 15, Height = 15 },
}
