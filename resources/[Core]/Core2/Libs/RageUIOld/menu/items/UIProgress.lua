...
local SettingsButton = {
    Rectangle = { Y = 0, Width = 350, Height = 40 },
    Text = { X = 8, Y = 8, Scale = 0.23
 },
    LeftBadge = { Y = 5, Width = 30, Height = 30 },
    RightBadge = { X = 300, Y = 5, Width = 30, Height = 30 },
    RightText = { X = 330, Y = 8, Scale = 0.23
 },
    SelectedSprite = { Dictionary = "RageUI_", Texture = "custom_gradient_nav", Y = 0, Width = 350, Height = 40 },
}

---@type table
local SettingsProgress = {
    Background = { X = 250, Y = 5, Width = 100, Height = 20 },
    Progress = { X = 250, Y = 5, Width = 100, Height = 20 },
    Text = { X = 275, Y = 8, Scale = 0.23
 },
}
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                ...
                RenderSprite(SettingsButton.SelectedSprite.Dictionary, SettingsButton.SelectedSprite.Texture, CurrentMenu.X, CurrentMenu.Y + SettingsButton.SelectedSprite.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, SettingsButton.SelectedSprite.Width + CurrentMenu.WidthOffset, SettingsButton.SelectedSprite.Height, false, 17, 17, 17, 255)
                ...
                if Enabled == true or Enabled == nil then
                    if Selected then
                        ...
                        RenderRectangle(CurrentMenu.X + SettingsProgress.Background.X, CurrentMenu.Y + SettingsProgress.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, SettingsProgress.Background.Width + CurrentMenu.WidthOffset, SettingsProgress.Background.Height, 17, 17, 17, 255)
                        ...
                        RenderRectangle(CurrentMenu.X + SettingsProgress.Bar.X, CurrentMenu.Y + SettingsProgress.Bar.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, ((ProgressStart / #Items) * (SettingsProgress.Bar.Width + CurrentMenu.WidthOffset)), SettingsProgress.Bar.Height, 17, 17, 17, 255)
                    end
                else
