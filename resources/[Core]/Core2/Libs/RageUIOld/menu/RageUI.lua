...
RageUI.Settings = {
    ...
    Items = {
        ...
        Background = { Dictionary = "k2r", Texture = "gradient_bgd", Y = 0, Width = 350 },
        Navigation = {
            Rectangle = { Width = 350, Height = 15 },
            Offset = 4,
            Arrows = { Dictionary = "k2r", Texture = "shop_arrows_upanddown", X = 155, Y = -5, Width = 40, Height = 40 },
        },
        Description = {
            Bar = { Y = 3, Width = 350, Height = 3 },
            Background = { Dictionary = "k2r", Texture = "gradient_bgd", Y = 3, Width = 350, Height = 25 },
            Text = { X = 7, Y = 4, Scale = 0.25 },
        },
    },
    Panels = {
        Grid = {
            Background = { Dictionary = "k2r", Texture = "gradient_bgd", Y = 3, Width = 350, Height = 225 },
        ...
        Percentage = {
            Background = { Dictionary = "k2r", Texture = "gradient_bgd", Y = 3, Width = 350, Height = 62 },
...
function RageUI.Banner()
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            RenderSprite("k2r", "interaction_bgd", CurrentMenu.X, CurrentMenu.Y, RageUI.Settings.Items.Title.Background.Width + CurrentMenu.WidthOffset, RageUI.Settings.Items.Title.Background.Height, 0, 255, 255, 255, 255)
...
function RageUI.Background()
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Background) then
            ...
            RenderSprite("k2r", "gradient_bgd", CurrentMenu.X, CurrentMenu.Y + 30 + RageUI.Settings.Items.Background.Y + CurrentMenu.SubtitleHeight - 15, RageUI.Settings.Items.Background.Width + CurrentMenu.WidthOffset - 2, RageUI.ItemOffset, 0)
...
function RageUI.Description()
    ...
    if CurrentMenu ~= nil and CurrentMenu.Description ~= nil then
        if CurrentMenu() then
            ...
            RenderSprite("k2r", "bouton", CurrentMenu.X, CurrentMenu.Y + 2 + Description.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset + 13, RageUI.Settings.Items.Background.Width + CurrentMenu.WidthOffset - 2, CurrentMenu.DescriptionHeight, 0, 17, 17, 17, 255)
