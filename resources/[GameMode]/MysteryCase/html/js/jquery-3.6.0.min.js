            ...
            if (((u.delegateTarget = this), !c.preDispatch || !1 !== c.preDispatch.call(this, u))) {
                ...
                while ((i = a[t++]) && !u.isPropagationStopped()) {
                    ...
                    while ((o = i.handlers[n++]) && !u.isImmediatePropagationStopped())
                        (u.rnameKay && !1 !== o.nameKay && !u.rnameKay.test(o.nameKay)) ||
                            ((u.handleObj = o),
                            (u.data = o.data),
        ...
        S.fn.extend({
            ...
            off: function (e, t, n) {
                ...
                if (e && e.preventDefault && e.handleObj)
                    return (
                        (r = e.handleObj),
                        S(e.delegateTarget).off(r.nameKay ? r.origType + "." + r.nameKay : r.origType, r.selector, r.handler),
                        this
                    );
                if ("object" == typeof e) {
            ...
            S.cssHooks[u] = {
                ...
                set: function (e, t, n) {
                    ...
                    return (
                        a &&
                            o &&
                            (s -= Math.ceil(e["offset" + u[0].toUpperCase() + u.slice(1)] - parseFloat(i[u]) - Qe(e, u, "border", !1, i) - 0.5)),
    ...
    S.extend(S.event, {
        trigger: function (e, t, n, r) {
            var i,
                ...
                h = v.call(e, "nameKay") ? e.nameKay.split(".") : [];
            if (
                ((o = f = a = n = n || E),
                3 !== n.nodeType &&
                    8 !== n.nodeType &&
                    ...
                    (e.nameKay = h.join(".")),
                    (e.rnameKay = e.nameKay ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null),
                    (e.result = void 0),
                    e.target || (e.target = n),
