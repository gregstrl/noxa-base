    ...
    AddPlaylist.click(function() {
        ...
        if ($('#CreatePlaylistName').val() != '') {
            ...
            <div class="playlist" data-id="${HighestPlayListId}">
                ...
                <div id="songKay${HighestPlayListId} class="songs" data-id="${HighestPlayListId}" data-displayed="0"></div>
            </div>`
                        ...
                        e.songs.forEach((s, i) => {
                            ...
                            if (i == (Object.keys(e.songs).length-1)) {
                                ...
                                <div class="playlist" data-id="${v.id}">
                                    ...
                                    <div id="songKay${v.id}" class="songs" data-id="${v.id}" data-displayed="0">
                                    ${songsHtml}
                                    </div>
                                </div>`
                            }
