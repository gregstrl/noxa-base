            ...
            if CurrentMenu.Pagination.Minimum <= Option and CurrentMenu.Pagination.Maximum >= Option then
                ...
                if Selected then
                    RenderSprite("commonmenu", "bouton_contour", CurrentMenu.X + 15,
                        ...
                        SettingsButton.SelectedSprite.Height - 1, 0, 227, 43, 58, 255)
                end
                ...
                RenderRectangle(CurrentMenu.X + SettingsSlider.Background.X + CurrentMenu.WidthOffset - RightOffset, CurrentMenu.Y + SettingsSlider.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset, SettingsSlider.Background.Width, SettingsSlider.Background.Height, 14, 19, 24, 255)
