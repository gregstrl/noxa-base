    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Subtitle) then
            ...
            if CurrentMenu.Subtitle ~= "" then
                RenderSprite("RageUI_", "custom_gradient_nav",  CurrentMenu.X, CurrentMenu.Y + RageUI.ItemOffset - 8, RageUI.Settings.Items.Subtitle.Background.Width + CurrentMenu.WidthOffset - 22,  RageUI.Settings.Items.Subtitle.Background.Height + CurrentMenu.SubtitleHeight, 0, CurrentMenu.Display.BackgroundItemsColor.r, CurrentMenu.Display.BackgroundItemsColor.g, CurrentMenu.Display.BackgroundItemsColor.b, CurrentMenu.Display.BackgroundItemsColor.a)
...
function RageUI.Description()
    ...
    if CurrentMenu ~= nil and CurrentMenu.Description ~= nil then
        if CurrentMenu() then
            ...
            RenderSprite("commonmenu", "bouton", CurrentMenu.X, CurrentMenu.Y + 2 + Description.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset + 13, RageUI.Settings.Items.Background.Width + CurrentMenu.WidthOffset - 2, CurrentMenu.DescriptionHeight, 0, 14, 19, 24, 255)
