...
OXSitConfig.MaxDistance = 2.5
OXSitConfig.Debug = false

OXSitConfig.Visual = {
	icon = 'fas fa-couch',
	label = 'S\'asseoir',
	notification = 'Il y a déjà quelqu\'un.',
	error = 'Vous êtes déjà assi.'
}

OXSitConfig.Keyboard = 'x'
