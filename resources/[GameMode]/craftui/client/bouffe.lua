...
local ShopConfig = {
    pos = vector3(1130.026367, -989.263184, 45.968159),
    heading = 102.33726501465,
    ...
    items = {
        {label = "Mangue", name = "mango", price = 150},
        {label = "Chips", name = "chips", price = 50},
        {label = "Cacahuètes", name = "peanuts", price = 40}
    }
}
