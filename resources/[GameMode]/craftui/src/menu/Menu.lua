...
function RageUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.Display.BackgroundItemsColorHover = {r = 108, g = 0, b = 166, a = 255};

    Menu.Display.BackgroundItemsColor = {r = 34, g = 34, b = 34, a = 255};

    Menu.Display.BackgroundColor = {r = 17, g = 17, b = 17, a = 255};
