...
Config.BuilderSettings = { 
    PropertiesType = 1,
    PropertyInfos = {},
    AnnounceList = {Index = 1, "Ouvert~s~", "Fermé~s~", "Autres~s~"},
	InteriorsList = {
		Index = 1, 
		"Appartement Modeste~s~", "Appartement (Motel)~s~",
		"Appartement Moderne~s~", "Appartement Luxueux #1~s~",
		"Appartement Luxueux #2~s~", "Appartement Luxueux #3~s~",
		"Appartement Luxueux #4~s~", "Maison Moderne #1~s~",
		"Maison Moderne #2~s~", "Bureau~s~",
		"Bureau - (Stock)~s~", "Bureau - (Avocat)~s~",
		"Club de bikers~s~", "Entrepôt (Petit)~s~", 
		"Entrepôt (Moyen)~s~", "Entrepôt (Grand)~s~"
	},
    GarageList = {Index = 1, "2 places~s~", "4 places~s~", "6 places~s~", "10 places~s~"},
    StorageList = {Index = 1, "50KG~s~", "75KG~s~", "125KG~s~", "250KG~s~"},
