local GridPanelHorizontal = {
    Background = { Dictionary = "commonmenu", Texture = "gradient_bgd", Y = 4, Width = 415, Height = 150 },
    Grid = { Dictionary = "RageUI", Texture = "horizontal_grid", X = 112, Y = 0, Width = 200, Height = 200 },
