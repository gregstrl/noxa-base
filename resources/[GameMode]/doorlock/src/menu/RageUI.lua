...
function RageUI.CloseAll()
    menuOpen = false
    if RageUI.CurrentMenu ~= nil then
        if RageUI.CurrentMenu.Closed ~= nil then RageUI.CurrentMenu.Closed()
        end
        if RageUI.CurrentMenu.Parent ~= nil and RageUI.CurrentMenu.Parent.Closed ~= nil then RageUI.CurrentMenu.Parent.Closed() end
            ...
            if RageUI.CurrentMenu ~= nil then
                if RageUI.CurrentMenu() then
                    ...
                    RageUI.ItemsSafeZone(RageUI.CurrentMenu)
                        ...
                        RenderSprite("commonmenu", "interaction_bgd", RageUI.CurrentMenu.X, RageUI.CurrentMenu.Y, RageUI.Settings.Items.Title.Background.Width + RageUI.CurrentMenu.WidthOffset, RageUI.Settings.Items.Title.Background.Height, nil)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            ...
            if CurrentMenu.Subtitle ~= "" then
                ...
                RenderRectangle(
                    CurrentMenu.X, 
                    CurrentMenu.Y + RageUI.ItemOffset, 
                ...
                -- Subtitle text
                RenderText(
                    (CurrentMenu.PageCounterColour or "") .. CurrentMenu.Subtitle, 
                    CurrentMenu.X + RageUI.Settings.Items.Subtitle.Text.X + 8, 
                    CurrentMenu.Y + RageUI.Settings.Items.Subtitle.Text.Y + RageUI.ItemOffset - 8, 
                    0, 
                ...
                -- Pagination
                if CurrentMenu.Pagination then
                ...
                -- Page counter
                if not CurrentMenu.PageCounter then
                    RenderText(RageUI.CurrentMenu.PageCounterColour .. RageUI.CurrentMenu.Index .. " / " .. RageUI.CurrentMenu.Options, RageUI.CurrentMenu.X + RageUI.Settings.Items.Subtitle.PreText.X + RageUI.CurrentMenu.WidthOffset - 8, RageUI.CurrentMenu.Y + RageUI.Settings.Items.Subtitle.PreText.Y + RageUI.ItemOffset - 8, 0, RageUI.Settings.Items.Subtitle.PreText.Scale, 255, 255, 255, 255, 2)
                else
                    RenderText(RageUI.CurrentMenu.PageCounter, RageUI.CurrentMenu.X + RageUI.Settings.Items.Subtitle.PreText.X + RageUI.CurrentMenu.WidthOffset - 8, RageUI.CurrentMenu.Y + RageUI.Settings.Items.Subtitle.PreText.Y + RageUI.ItemOffset - 8, 0, RageUI.Settings.Items.Subtitle.PreText.Scale, 255, 255, 255, 255, 2)
                end
        ...
        if CurrentMenu() then
            ...
            if CurrentMenu.Sprite and CurrentMenu.Sprite.Dictionary then
                RenderSprite(
                    ...
                    CurrentMenu.X,
                    CurrentMenu.Y + RageUI.Settings.Items.Background.Y + CurrentMenu.SubtitleHeight,
                    RageUI.Settings.Items.Background.Width + CurrentMenu.WidthOffset,
                    RageUI.ItemOffset,
                    CurrentMenu.Sprite.Color and CurrentMenu.Sprite.Color.R or 0,
                    CurrentMenu.Sprite.Color and CurrentMenu.Sprite.Color.G or 0,
                    CurrentMenu.Sprite.Color and CurrentMenu.Sprite.Color.B or 0,
                    CurrentMenu.Sprite.Color and CurrentMenu.Sprite.Color.A or 255
                )
            else
...
function RageUI.Description()
    ...
    if CurrentMenu ~= nil and CurrentMenu.Description ~= nil then
        if CurrentMenu() then
            ...
            RenderSprite("commonmenu", "gradient_nav", CurrentMenu.X, CurrentMenu.Y + 2 + Description.Background.Y + CurrentMenu.SubtitleHeight + RageUI.ItemOffset + 13, RageUI.Settings.Items.Background.Width + CurrentMenu.WidthOffset - 2, CurrentMenu.DescriptionHeight, 0, 17, 17, 17, 255)
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() then
            ...
            if CurrentMenu.Controls.Back.Enabled and CurrentMenu.Closable then
                if CurrentMenu.Controls.Back.Pressed and (not isWaitingForServer) then
...
function RageUI.ItemsDescription(CurrentMenu, Description, Selected)
    ...
    if Description and Description ~= "" then
        ...
        if Selected and CurrentMenu.Description ~= Description then
            ...
            -- Ajustement de la hauteur en fonction du nombre de lignes
            if DescriptionLineCount > 1 then
                CurrentMenu.DescriptionHeight = SettingsDescription.Background.Height * DescriptionLineCount
            else
                -- Ajout d'un petit padding pour une meilleure lisibilité
                CurrentMenu.DescriptionHeight = SettingsDescription.Background.Height + 7
            end
        end
    else
        -- Réinitialisation de la description si elle est vide ou nil
        if Selected then
