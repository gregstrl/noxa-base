...
class RadialProgress extends RProgress {
    ...
    init() {
        ...
        this.dials = {
            bg: new Circle(
                ...
                this.config.s / 2.0 + this.config.padding,    
        ...
        fgNode.setAttributeNS(null, "stroke-linecap", "round"); 
        fgNode.setAttributeNS(null, "stroke", this.config.color); 
    
        this.dials.bg.getNode().setAttributeNS(null, "stroke", this.config.bgColor);
        this.dials.bg.getNode().setAttributeNS(null, "stroke-opacity", this.config.bgOpacity);
    ...
    setRotation(angle) {
        ...
        this.svg.getNode().style.transform = `rotate(${(this.config.rotation - 270)}deg)`;
    }
    ...
    setProgress(progress, e) {
        ...
        // Inverser la direction de la progression
        this.dials.fg.setProgress(1 - (progress / 100));
