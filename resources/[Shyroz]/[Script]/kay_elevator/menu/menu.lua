...
function RageUI.Banner()
    ...
    if CurrentMenu ~= nil then
        if CurrentMenu() and (CurrentMenu.Display.Header) then
            ...
            if CurrentMenu.Sprite ~= nil and CurrentMenu.Sprite.Dictionary ~= nil and CurrentMenu.Sprite.Dictionary ~= 'k2ra' then
...
function RageUI.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "k2ra", Texture = Texture or "interaction_bgd" }
    self.Rectangle = nil
end
